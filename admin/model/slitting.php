...
class slitting extends dbclass{
	...
	//	printr($data);
		...
		$sql = "INSERT INTO `" . DB_PREFIX . "slitting` SET  slitting_no = '" .$data['slitting_no']. "',slitting_date = '" .$data['slitting_date']. "',job_id = '" .$data['job_id']. "',job_name = '" .$data['job_name']. "',job_no = '" .$data['job_name_text']. "',operator_id = '" .$data['operator_id']. "',junior_id = '" .$data['junior_id']. "',machine_id = '" .$data['machine_id']. "',shift = '" .$data['shift']. "',remarks_slitting = '" .$data['remarks_slitting']. "',remark='".$remark."',roll_code_id='".$data['roll_code_id']."',slitting_status='".$data['slitting_status']."',input_qty='".$data['input_qty']."',output_qty='".$data['output_qty']."',setting_wastage='".$data['setting_wastage']."',top_cut_wastage='".$data['top_cut_wastage']."',lamination_wastage='".$data['lamination_wastage']."',printing_wastage='".$data['printing_wastage']."',trimming_wastage='".$data['trimming_wastage']."',total_wastage='".$data['total_wastage']."',wastage='".$data['wastage']."',date_added = NOW(),date_modify = NOW(),is_delete=0,added_user_id='".$_SESSION['ADMIN_LOGIN_SWISS']."', added_user_type_id='".$_SESSION['LOGIN_USER_TYPE']."'";
		$this->query($sql);
		...
		if($data['slitting_status']==1){
			...
			foreach($data['roll_details'] as $roll_no)
							...
							//	printr($roll_no);
                                	$this->query("INSERT INTO   slitting_process SET slitting_id ='".$slitting_id."',job_id = '" .$data['job_id']. "',roll_code_id='".$data['roll_code_id']."',roll_code = '" .$roll_no['roll_code']. "',input_qty = '".$roll_no['r_input_qty']."',output_qty = '".$roll_no['r_output_qty']."',p_input_qty = '".$roll_no['r_output_qty']."', date_added = NOW(),date_modify = NOW(),is_delete=0");
...
//	printr($data);die;
		...
		$sql = "UPDATE`" . DB_PREFIX . "slitting` SET  slitting_no = '" .$data['slitting_no']. "',slitting_date = '" .$data['slitting_date']. "',job_id = '" .$data['job_id']. "',job_name = '" .$data['job_name']. "',job_no = '" .$data['job_name_text']. "',operator_id = '" .$data['operator_id']. "',junior_id = '" .$data['junior_id']. "',machine_id = '" .$data['machine_id']. "',shift = '" .$data['shift']. "',remarks_slitting = '" .$data['remarks_slitting']. "',remark='".$remark."',slitting_status='".$data['slitting_status']."',input_qty='".$data['input_qty']."',output_qty='".$data['output_qty']."',setting_wastage='".$data['setting_wastage']."',top_cut_wastage='".$data['top_cut_wastage']."',lamination_wastage='".$data['lamination_wastage']."',printing_wastage='".$data['printing_wastage']."',trimming_wastage='".$data['trimming_wastage']."',total_wastage='".$data['total_wastage']."',wastage='".$data['wastage']."',date_added = NOW(),date_modify = NOW(),is_delete=0,added_user_id='".$_SESSION['ADMIN_LOGIN_SWISS']."', added_user_type_id='".$_SESSION['LOGIN_USER_TYPE']."' WHERE slitting_id = '" .(int)$slitting_id."' ";
		$this->query($sql);
