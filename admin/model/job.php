...
//	printr($data);die;
        ...
        $sql = "INSERT INTO job_master SET job_no='".$data['job_no']."',job_name = '" . $data['jobname'] . "',product_name = '" . $data['product_name'] . "',job_type = '" . $data['job_type'] . "',print_type = '" . $data['print_type'] . "',pouch_type = '" . $data['pouch_type'] . "',job_date = '" . $data['job_date'] . "',country_id = '" . $data['country_id']. "',user_details = '" . $data['user_details']."',product='".$data['product']."', size_pro = '" . $data['size_pro']."',width = '" . $data['width']."',height = '" . $data['height']."',gusset = '" . $data['gusset']."',printing_option = '" . $data['printing_option']."',layers = '" . $data['layers']."',m_process = '" . $data['m_process']."',no_of_pouch = '" . $data['no_of_pouch']."',cylinder_length = '" . $data['cylinder_length']."',cylinder_cir_cum = '" . $data['cylinder_cir_cum']."',job_color = '" . $data['job_color']."',sealing = '" . $data['sealing']."',status = '" . $data['status']."', date_added = NOW(),date_modify = NOW(),is_delete=0";
	...
	//	printr($file);die;
		if(!isset($data['user_details']))
		 ...
		 $sql = "UPDATE job_master SET job_no='".$data['job_no']."', job_name = '" . $data['jobname'] . "', product_name = '" . $data['product_name'] . "',job_type = '" . $data['job_type'] . "',print_type = '" . $data['print_type'] . "',pouch_type = '" . $data['pouch_type'] . "',job_date = '" . $data['job_date'] . "',country_id = '" . $data['country_id']. "',user_details = '" . $data['user_details']."',product='".$data['product']."', size_pro = '" . $data['size_pro']."',width = '" . $data['width']."',height = '" . $data['height']."',gusset = '" . $data['gusset']."',printing_option = '" . $data['printing_option']."',layers = '" . $data['layers']."',m_process = '" . $data['m_process']."',sealing = '" . $data['sealing']."',cylinder_length = '" . $data['cylinder_length']."',cylinder_cir_cum = '" . $data['cylinder_cir_cum']."',job_color = '" . $data['job_color']."',no_of_pouch = '" . $data['no_of_pouch']."',status = '" . $data['status']."', date_added = NOW(),date_modify = NOW(),is_delete=0 WHERE job_id = '" .$data['jobid']. "'";
