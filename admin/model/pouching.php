...
class pouching extends dbclass{
	...
	public function addpouching($data)
	{
		...
		$sql = "INSERT INTO `" . DB_PREFIX . "pouching` SET  pouching_no = '" .$data['pouching_no']. "',pouching_date = '" .$data['pouching_date']. "',job_id = '" .implode(",",$data['job_id']). "',operator_id = '" .$data['operator_id']. "',junior_id = '" .$data['junior_id']. "',machine_id = '" .$data['machine_id']. "',zipper_used = '" .$data['zipper_used']. "',zipper_used_kg = '" .$data['zipper_used_kg']. "',zipper_id = '" .$data['zipper_id']. "',start_time = '" .$data['start_time']. "',end_time = '" .$data['end_time']. "',shift = '" .$data['shift']. "',remark='".$remark."',remark_pouching='".$data['remark_pouching']."',output_qty='".$data['output_qty']."',output_qty_kg='".$data['output_qty_kg']."',output_qty_meter='".$data['output_qty_meter']."',sorting_wastage='".$data['sorting_wastage']."',top_cut_wastage='".$data['top_cut_wastage']."',online_setting_wastage='".$data['online_setting_wastage']."',printing_wastage='".$data['printing_wastage']."',trimming_wastage='".$data['trimming_wastage']."',lamination_wastage='".$data['lamination_wastage']."',total_wastage='".$data['total_wastage']."',operator_wastage='".$data['operator_wastage']."',total_wastage_c='".$data['total_wastage_c']."',date_added = NOW(),date_modify = NOW(),is_delete=0,added_user_id='".$_SESSION['ADMIN_LOGIN_SWISS']."', added_user_type_id='".$_SESSION['LOGIN_USER_TYPE']."'";
		$this->query($sql);
	//	echo $sql;
		...
		if(isset($data['job_id']) && !empty($data['job_id'])){
			...
			foreach($data['job_id'] as $key=>$job_id){				
				$this->query("UPDATE" . DB_PREFIX . " job_master  SET pouching_status = '1' ,pouching_id='".$pouching_id."'	WHERE job_id = '".$job_id."'");
			}
		}
	...
	{
		$sql = "SELECT pouching_id FROM `" . DB_PREFIX . "pouching` WHERE is_delete = 0 ORDER BY  pouching_id DESC";
		$data = $this->query($sql);
		if($data->num_rows){
	...
	public function view_pouching_report($pouching_id)
	{
		
		$data = $this->getPouchDetail($pouching_id);
		$job_d = explode(',',$data['job_id']);	
		 $product_name = $this->zipper_name($data['zipper_id']);
		 $job_detail = $this->input_roll_details_view($job_d);
		...
		$html.='</div><div class="div_first" style=" width: 100%;float: left;  border: 1px solid black;font-size: 18px;">
							...
							<td style="vertical-align: top;width: 50%;"><b> Pouching machine Name  : </b>   '. ucwords($data['machine_name']).'
								...
								<table style="width: 100%;" >
							<tr>
							<td style="vertical-align: top;width: 50%;" colspan="3"><div style="text-align:center;border: 1px solid black;"><b> Input Roll Details  </b></td>
							...
							<td style="vertical-align: top;width: 25%;" id="data"><div align="center"><b>Input Qty</b></div></td>
							</tr>';
							if(!empty($job_detail['slitting'] )){
							foreach($job_detail['slitting']  as $job ) {
								...
								$html.='<tr>
										...
										<td style="vertical-align: top;width:25%;" id="data"><div align="center">'.$job['output_qty'].'</div></td>
										</tr>';
					...
					<table cellspacing="0px" cellpadding="10px" border="1" style="width: 100%; border-spacing: 0px;font-size: 14px;">
						...
						<tr>
								...
								<td width="8%"><div align="center"><b>Pouching No </b></div></td>	
								<td width="8%"><div align="center"><b>Operator Name</b></div></td>	
								<td width="8%"><div align="center"><b>Output Qty (Nos)</b></div></td>	
								<td width="8%"><div align="center"><b>Output Qty (Kgs)</b></div></td>								
								<td width="8%"><div align="center"><b>Output Qty (meter)</b></div></td>								
								<td width="8%"><div align="center"><b>zipper</b></div></td>
								<td width="8%"><div align="center"><b>zipper used (meter)</b></div></td>
								<td width="8%"><div align="center"><b>zipper used (kgs)</b></div></td>							
						</tr>
						<tr>
						 
						
								<td width="8%"><div align="center"><b>'.$data['pouching_no'].'</b></div></td>	
								<td width="8%"><div align="center"><b><b>Main : </b>'.$data['operator_name'].'  <br>'.$junior_name.'</b></div></td>	
								<td width="8%"><div align="center"><b>'.$data['output_qty'].'</b></div></td>	
								<td width="8%"><div align="center"><b>'.$data['output_qty_kg'].'</b></div></td>								
								<td width="8%"><div align="center"><b>'.$data['output_qty_meter'].'</b></div></td>								
								<td width="8%"><div align="center"><b>'.$product_name.'</b></div></td>
								<td width="8%"><div align="center"><b>'.$data['zipper_used'].'</b></div></td>
								<td width="8%"><div align="center"><b>'.$data['zipper_used_kg'].'</b></div></td>								
						</tr>
						<tr>
								<td style="vertical-align: top;width: 50%;" colspan="8"><div style="text-align:center;border: 1px solid black;"><b>  Wastage Details </b></td>
						</tr>		 
							
						<tr>
						 
						
								<td width="8%"><div align="center"><b>Sorting Wastage (Kgs)</b></div></td>	
								<td width="8%"><div align="center"><b>Top Cut (Kgs)</b></div></td>	
								<td width="8%"><div align="center"><b>Online Setting Wastage(Kgs)</b></div></td>	
								<td width="8%"><div align="center"><b>Printing Wastage (Kgs)</b></div></td>								
								<td width="8%"><div align="center"><b>Lamination Wastage (Kgs)</b></div></td>								
								<td width="8%"><div align="center"><b>Trimming Wastage (Kgs)</b></div></td>
								<td width="8%"><div align="center"><b>Total  Wastage (%)</b></div></td>
								<td width="8%"><div align="center"><b>Operator Wastage (%)</b></div></td>								
						</tr>



						<tr>
								<td width="8%"><div align="center"><b>'.$data['sorting_wastage'].'</b></div></td>	
								<td width="8%"><div align="center"><b>'.$data['top_cut_wastage'].'</b></div></td>	
								<td width="8%"><div align="center"><b>'.$data['online_setting_wastage'].'</b></div></td>	
								<td width="8%"><div align="center"><b>'.$data['printing_wastage'].'</b></div></td>								
								<td width="8%"><div align="center"><b>'.$data['lamination_wastage'].'</b></div></td>								
								<td width="8%"><div align="center"><b>'.$data['trimming_wastage'].'</b></div></td>
								<td width="8%"><div align="center"><b>'.$data['total_wastage'].' %</b></div></td>
								<td width="8%"><div align="center"><b>'.$data['operator_wastage'].' %</b></div></td>											
						</tr>
							</tbody><tbody></table>
						</div>';
