...
class multiProductQuotation extends dbclass{
	...
	public function getQuotationSelectedData($quotation_id,$selected,$user_type_id="",$user_id=""){
		if($user_type_id && $user_id){
			if($user_id == 1 && $user_type_id == 1){
				$sql = "SELECT $selected FROM " . DB_PREFIX ."multi_product_quotation as mp,multi_product_quotation_id as mpi WHERE mp.product_quotation_id = '".(int)$quotation_id."' AND mp.multi_product_quotation_id=mpi.multi_product_quotation_id";
			}else{
				$sql = "SELECT $selected FROM " . DB_PREFIX ."multi_product_quotation as mp,multi_product_quotation_id as mpi WHERE mp.added_by_user_id = '".(int)$user_id."' AND mp.added_by_user_type_id = '".(int)$user_type_id."' AND mp.product_quotation_id = '".(int)$quotation_id."' AND mp.multi_product_quotation_id=mpi.multi_product_quotation_id";
			}
		}else{
			$sql = "SELECT $selected FROM " . DB_PREFIX ."multi_product_quotation as mp,multi_product_quotation_id as mpi WHERE mp.product_quotation_id = '".(int)$quotation_id."' AND mp.multi_product_quotation_id=mpi.multi_product_quotation_id";
		}
	...
	public function getQuotationSelectedData1($quotation_id,$selected,$user_type_id="",$user_id=""){
		if($user_type_id && $user_id){
			if($user_id == 1 && $user_type_id == 1){
				$sql = "SELECT $selected FROM " . DB_PREFIX ."multi_product_quotation as mp,multi_product_quotation_id as mpi WHERE mpi.multi_product_quotation_id = '".(int)$quotation_id."' AND mp.multi_product_quotation_id=mpi.multi_product_quotation_id";
			}else{
				$sql = "SELECT $selected FROM " . DB_PREFIX ."multi_product_quotation as mp,multi_product_quotation_id as mpi WHERE mp.added_by_user_id = '".(int)$user_id."' AND mp.added_by_user_type_id = '".(int)$user_type_id."' AND mpi.multi_product_quotation_id = '".(int)$quotation_id."' AND mp.multi_product_quotation_id=mpi.multi_product_quotation_id";
			}
		}else{
			$sql = "SELECT $selected FROM " . DB_PREFIX ."multi_product_quotation as mp,multi_product_quotation_id as mpi WHERE mpi.multi_product_quotation_id = '".(int)$quotation_id."' AND mp.multi_product_quotation_id=mpi.multi_product_quotation_id";
		}
	...
	public function getQuotation($quotation_id,$getData = '*',$user_type_id='',$user_id=''){
		if($user_type_id && $user_id){
			if($user_id == 1 && $user_type_id == 1){
			$sql = "SELECT $getData,cn.country_name,mpqi.multi_quotation_number,mpqi.address_book_id  FROM " . DB_PREFIX ."multi_product_quotation pq INNER JOIN " . DB_PREFIX ."country cn ON (pq.shipment_country_id=cn.country_id) INNER JOIN multi_product_quotation_id as mpqi ON(pq.multi_product_quotation_id=mpqi.multi_product_quotation_id)  WHERE pq.multi_product_quotation_id = '".(int)$quotation_id."'";
			}else{
			...
			$sql = "SELECT $getData,cn.country_name,mpqi.multi_quotation_number,mpqi.address_book_id  FROM " . DB_PREFIX ."multi_product_quotation pq INNER JOIN " . DB_PREFIX ."country cn ON (pq.shipment_country_id=cn.country_id) INNER JOIN " . DB_PREFIX ."multi_product_quotation_id mpqi ON (pq.multi_product_quotation_id=mpqi.multi_product_quotation_id) WHERE  pq.multi_product_quotation_id = '".(int)$quotation_id."' AND (( pq.added_by_user_id = '".(int)$set_user_id."' AND pq.added_by_user_type_id = '".(int)$set_user_type_id."') $str ";
				
			}
		}else{
			$sql = "SELECT $getData,mpqi.multi_quotation_number,mpqi.address_book_id FROM " . DB_PREFIX ."multi_product_quotation pq,multi_product_quotation_id mpqi WHERE pq.multi_product_quotation_id=mpqi.multi_product_quotation_id  AND pq.multi_product_quotation_id = '".(int)$quotation_id."'";
			...
			foreach($data->rows as $qunttData){ //printr($qunttData);
				...
				if($zdata->num_rows){
					...
					foreach($zdata->rows as $zipData){
						...
						$addedByInfo = $this->getUser($qunttData['added_by_user_id'],$qunttData['added_by_user_type_id']);
						$lang_details = $this->getLangDetails($addedByInfo['lang_id'],$qunttData['added_by_user_id'],$qunttData['added_by_user_type_id']);
						
						$laser_type =$laser_lang='';
						if($zipData['laser_id']!=0)
						{
							$laser_type=$this->getLaserType($zipData['laser_id']);
							$laser_sql=$this->query("SELECT * FROM laser_scoring_types WHERE type_id = '".$zipData['laser_id']."'");
							if($laser_sql->num_rows)
							    $laser_lang = ', '.$laser_sql->row['laser_name_'.$lang_details['language']];
						}
						...
						if($zipData['slider_place']!='')
						{
    						...
    						if($zipData['slider_place'] == 'Slider Zipper On Top Of Pouch')
    						{
    						    ...
    						    $tamper = '<br>'.$zipData['slider_place'].' '.$zipData['tamperevident'];
    						}
    						else
    						{
    						    $zipData['slider_place'] = 'Zipper Inside Of Pouch';
    						    $tamper = '<br>'.$zipData['slider_place'];
    						}
						}
						...
						$acc_lang=$acc_lang_sec='';
						if($zipData['accessorie_txt']=='No Accessorie')
							$zipData['accessorie_txt']='';
						else
						{
							$zipData['accessorie_txt']=' With '.$zipData['accessorie_txt'];
							$acc_sql=$this->query("SELECT * FROM product_accessorie WHERE product_accessorie_name = '".$zipData['accessorie_txt']."'");
							if($acc_sql->num_rows)    
							    $acc_lang = ', '.$acc_sql->row['product_accessorie_name_'.$lang_details['language']];
						}	
						if($zipData['accessorie_txt_corner']!='')
						{
						    $acc_cor_sql=$this->query("SELECT * FROM product_accessorie WHERE product_accessorie_name = '".$zipData['accessorie_txt_corner']."'");
						    if($acc_lang_sec->num_rows) 
						        $acc_lang_sec = '<br>, '.$acc_cor_sql->row['product_accessorie_name_'.$lang_details['language']];
						}
						if($zipData['spout_txt']=='No Spout')
						...
						$zip_lang=$spout_lang='';
					    $zip_nm = $this->query("SELECT * FROM product_zipper WHERE zipper_name = '".$zipData['zipper_txt']."'");
						$spout_sql=$this->query("SELECT * FROM product_spout WHERE spout_name = '".$zipData['spout_txt']."'");
						if($zip_nm->num_rows)
						    $zip_lang = $zip_nm->row['zipper_name_'.$lang_details['language']];
						if($spout_sql->num_rows)
						    $spout_lang = ',<br>'.$spout_sql->row['spout_name_'.$lang_details['language']];
						    
						if($zipData['valve_txt']=='With Valve')
						    $valve_txt = $lang_details['with_valve'];
						else
						    $valve_txt = $lang_details['no_valve'];
						    
						$txt_lang = $zip_lang.' '.$laser_lang.', '.$valve_txt;
						$txt_lang .= $spout_lang.' '.$acc_lang;
						$txt_lang .= $acc_lang_sec.''.$tamper.'<br> ';
						$txt_lang .=$handle_type['handle_name'];
						//printr($txt_lang);
							$return[$zipData['transport_type']][$qunttData['quantity']][] = array(
								...
								'make_name_french'=>utf8_encode($zipData['make_name_french']),
	...
	public function setQuotationCurrency($quotation_id,$currency_code,$currencyRate,$source,$sec_curr='',$sec_curr_rate=''){
			...
			$this->query("INSERT INTO " . DB_PREFIX . "multi_product_quotation_currency SET product_quotation_id = '".$quotation_id."', currency_id = '', currency_code = '".$currency_code."', currency_rate = '".(float)$currencyRate."', currency_base_rate = '', source = '".$source."',sec_curr='".$sec_curr."',sec_curr_rate='".$sec_curr_rate."',date_added = NOW()");
	...
	public function CheckQuotationTax($quotation_id)
	{
		...
		$sql = "SELECT zipper_txt,valve_txt,tax_type,tax_percentage,excies FROM " . DB_PREFIX ."multi_product_quotation_price WHERE product_quotation_id = '".(int)$quotation_id."' ORDER BY product_quotation_price_id ASC LIMIT 1";
		$data = $this->query($sql);
		//printr($data);
		return $data->row;
	}	
		...
		if($data['product'] == "6"){
			...
			if($type=='Q')
			{
				...
				else
				{
					...
					if(!isset($datacontacts->row['email_1']) && empty($datacontacts->row['email_1']))
					{
							...
							if($dataadd->num_rows)
							{
								$sql2 = "UPDATE company_address SET email_1 = '" .addslashes($data['email']). "',country = '" . $data['country_id'] . "' WHERE company_address_id ='" . $dataadd->row['company_address_id'] . "'";
								$datasql2 = $this->query($sql2);
							}
							else
							{
								$sql2 = "INSERT INTO  company_address  SET  address_book_id = '" . $address_book_id . "',country = '" . $data['country_id'] . "', email_1 = '" . addslashes($data['email']) . "' ,user_id='" . $_SESSION['ADMIN_LOGIN_SWISS'] . "' ,user_type_id = '" . $_SESSION['LOGIN_USER_TYPE'] . "' , date_added = NOW(),date_modify = NOW()";
								$datasql2 = $this->query($sql2);
							}
				    }
					else
					...
					$sql =  "INSERT INTO ".DB_PREFIX."multi_product_quotation_id SET  status = '0',address_book_id = '".$address_book_id."', date_added = NOW(),date_modify = NOW(), added_by_user_id = '".(int)$user_id."', added_by_user_type_id = '".(int)$user_type_id."'";		
					$this->query($sql);
			...
			elseif($type=='O')
			{
				...
				else
				{
					...
					$sql =  "INSERT INTO ".DB_PREFIX."multi_custom_order_id SET  company_name='".$this->escape($data['company'])."', website='".$data['website']."', customer_name='".$this->escape($customer_name)."', email = '".addslashes($data['email'])."', contact_number='".$data['contact_number']."', vat_number = '".$data['vat_number']."', shipping_address_id = '".$shipping_address_id."',  billing_address_id = '".$billing_address_id."', order_currency = '".$order_currency_query->row['currency_code']."',currency_rate = '".$order_currency_query->row['product_rate']."',order_note ='".$data['order_note']."', order_instruction = '".$data['order_instruction']."',custom_order_status=1,status = '0', date_added = NOW(),date_modify = NOW(), added_by_user_id = '".(int)$user_id."', added_by_user_type_id = '".(int)$user_type_id."'";		
					$this->query($sql);
			...
			//		$gress_qtywise_sair = $this->getGressQtyWise($quantity,'sea',$admin_user_id);
				...
				$i++;}
					...
					if($type=='Q')
					{
						...
						$sql =  "UPDATE  ".DB_PREFIX."multi_product_quotation_id SET multi_quotation_number = '".$quotation_number."' WHERE multi_product_quotation_id = '".$multi_product_quotation_id."'";
						$this->query($sql);
						...
						if(isset($taxation_data) && !empty($taxation_data))
						{
							...
							{
								//added & commented by kinjal for new gst on 4-10-2019	
					...
					//end p
								if(isset($productQuatiationId) && (int)$productQuatiationId > 0 ){
									...
									if($customer_email && decode($data['sel_currency']) > 0 ){
										...
										$this->query("INSERT INTO ".DB_PREFIX."multi_product_quotation_currency SET product_quotation_id = '".$productQuatiationId."', currency_id = '".$selCurrecy['currency_id']."', currency_code = '".$selCurrecy['currency_code']."', 	currency_rate = '".$selCurrencyRate."', currency_base_rate = '".$selCurrecy['price']."', date_added = NOW() ");
									}
													...
													$pricesql = "INSERT INTO ".DB_PREFIX."multi_product_quotation_price SET product_quotation_id = '".$productQuatiationId."', product_quotation_quantity_id = '".$productQuatiationQuantityId."', zipper_txt = '".$zipData['zip_text']."',gusset_printing_type='".$data['gusset_printing_option']."',valve_txt = '".$zipData['valve_text']."', date_added = NOW(), zipper_price = '".$zipData['calculateZipperPrice']."', spout_txt = '".$zipData['spout_txt']."', spout_base_price = '".$zipData['spout_price']."', accessorie_txt = '".$zipData['accessorie_txt']."', make_pouch = '".(int)$data['make']."',spout_pouch_type='".$zipData['spout_pouch_type']."',accessorie_base_price = '".$zipData['accessorie_price']."',valve_price = '".$zipData['valve_price']."' , accessorie_txt_corner = '".$zipData['accessorie_txt_corner']."', accessorie_base_price_corner = '".$zipData['accessorie_price_corner']."',actual_laser_price='".$laser_price."',laser_id='".$data['laser_name']."',handle_price = '".$handle_price."',handle_id='".$handle_id."',cyli_gress_price='".$cylinderCurrencyGressPrice."',gress_cyli_per='".$userInfo['gres_cyli']."',tamperevident='".$tamperevident."',slider_place='".$slider_place."',";
														...
														if(isset($taxation_data) && !empty($taxation_data))
														{
														    ...
														    if($data['normalform']=='Out Of Gujarat')
															{
																...
																$test['$totalPricWithExcies+($totalPricWithExcies*$taxation_data[igst]/100)']=$totalPricWithExcies.'+('.$totalPricWithExcies.'*'.$taxation_data['igst'].'/100)';
																$igst =$taxation_data['igst'];
															}
															else
															{
																$totalPriceWithTax = $totalPriceForTax+($totalPriceForTax*($taxation_data['cgst']+$taxation_data['sgst'])/100);
																$test['$totalPricWithExcies+($totalPricWithExcies*($taxation_data[cgst]+$taxation_data[sgst])/100)']=$totalPricWithExcies.'+('.$totalPricWithExcies.'*('.$taxation_data['sgst'].'+'.$taxation_data['sgst_percentage'].')/100)';
	...
	public function updateQuotationStatus($quotation_id,$status_value){
		...
		$sql = "UPDATE " . DB_PREFIX . "multi_product_quotation SET status = '".$status_value."', date_modify = NOW() WHERE multi_product_quotation_id = '" .(int)$quotation_id. "'";
		$this->query($sql);
		
		$sql = "UPDATE " . DB_PREFIX . "multi_product_quotation_id SET status = '".$status_value."', date_modify = NOW() WHERE multi_product_quotation_id = '" .(int)$quotation_id. "'";
		$this->query($sql);
	}
	...
	public function deleteQuotation($quotation_id){
		...
		if($data->num_rows){
		    foreach($data->rows as $row)
		    {
    			...
    			$this->query("DELETE  FROM " . DB_PREFIX . "multi_product_quotation  WHERE product_quotation_id='".$row['product_quotation_id']."'");
    			$this->query("DELETE  FROM " . DB_PREFIX . "multi_product_quotation_layer  WHERE product_quotation_id='".$row['product_quotation_id']."'");
    			$this->query("DELETE  FROM " . DB_PREFIX . "multi_product_quotation_price  WHERE product_quotation_id='".$row['product_quotation_id']."'");
    			$this->query("DELETE  FROM " . DB_PREFIX . "multi_product_quotation_quantity  WHERE product_quotation_id='".$row['product_quotation_id']."'");	
    			$this->query("DELETE  FROM " . DB_PREFIX . "multi_product_quotation_base_price  WHERE product_quotation_id='".$row['product_quotation_id']."'");
    			$this->query("DELETE  FROM " . DB_PREFIX . "multi_product_quotation_id  WHERE multi_product_quotation_id='".$row['product_quotation_id']."'");
		    }
		}
	...
	public function deleteProductQuotation($product_quotation_price_id){
		$cond='';
		$sql = "SELECT product_quotation_id,product_quotation_quantity_id  FROM " . DB_PREFIX ."multi_product_quotation_price WHERE product_quotation_price_id = '".(int)$product_quotation_price_id."'";
		$data = $this->query($sql);
		if($data->num_rows){
			$sql1 = "DELETE  FROM " . DB_PREFIX . "multi_product_quotation_price  WHERE product_quotation_price_id='".$product_quotation_price_id."'";
			$this->query($sql1);
		}
		$sql3 = "SELECT multi_product_quotation_id  FROM " . DB_PREFIX ."multi_product_quotation WHERE product_quotation_id = '".(int)$data->row['product_quotation_id']."'";
		$data3 = $this->query($sql3);
		$sql2 = "SELECT product_quotation_id  FROM " . DB_PREFIX ."multi_product_quotation WHERE multi_product_quotation_id = '".(int)$data3->row['multi_product_quotation_id']."'";
		...
		$sql4 = "SELECT product_quotation_price_id  FROM " . DB_PREFIX ."multi_product_quotation_price WHERE ".$cond."";
	...
	public function upadteQuotation($quotation_id,$country_id=''){
		$this->query("UPDATE " . DB_PREFIX . "multi_product_quotation SET status = '1', quotation_status = '1', date_modify = NOW() WHERE multi_product_quotation_id = '" .(int)$quotation_id. "'");
		$this->query("UPDATE " . DB_PREFIX . "multi_product_quotation_id SET status = '1', quotation_status = '1', date_modify = NOW() WHERE multi_product_quotation_id = '" .(int)$quotation_id. "'");
		//send emial code
	...
	{
		$this->query("UPDATE " . DB_PREFIX . "multi_product_quotation_quantity SET discount = ".$discount." WHERE product_quotation_quantity_id = '" .(int)$quantity_id. "'");
	}
	
	public function getQuotationPackingAndTransportDetails($quotation_id){
		$sql = "SELECT pqbp.packing_price,pq.spout_additional_packing_price,pqbp.transport_width_base_price,pqbp.transport_height_base_price FROM " . DB_PREFIX ."multi_product_quotation pq INNER JOIN " . DB_PREFIX ."multi_product_quotation_base_price pqbp ON (pq.product_quotation_id=pqbp.product_quotation_id) WHERE pq.product_quotation_id = '".(int)$quotation_id."'";
		$data = $this->query($sql);
		if($data->num_rows){
			return $data->row;
		}else{
	...
	public function sendQuotationEmail($quotation_id,$toEmail = '',$setQuotationCurrencyId='',$secondary_curr='',$sec_currency_rate='',$n=0){		
		...
		foreach($data as $dat)
	   {
				...
				/*	if($dat['product_id'] == '6')
					...
					*/
					...
					else
					{
						...
						{
						    $gussetval = ' { '. $arr[0]['gusset'].'mm Flap}';
						}
					}
		...
		if($addedByInfo)
		{
			...
			foreach($currency_rate as $cr)
			{
				...
				if($user_admin_id['country_id'] == '42')
					    $html .= '<div><b style="color:red">Note : </b>Taxes and transportation extra on above price.</div>';
				...
				if($acc_para=='1')
				{
				    $html .= '<div><b>All four Rounded Corners</b><br>Advantage of all four rounded corners in pouches, is they look more premium and artisan than the pointed corner ones.<br>There is always a great chance that the pointed corner in pouches can get injury to humans, as the pointed edges are very sharp like knife.</div>';
				}    
				...
				if($user_admin_id['country_id']=='14')
				 ...
				 if($user_admin_id['country_id'] == '42')
					    $html_gress .= '<div><b style="color:red">Note: </b>Taxes and transportation extra on above price.</div>';
				//elseif($addedByInfo['country_id']=='189' && $secondary_curr!='')
				...
				if($acc_para=='1')
				{
				    $html_gress .= '<div><b>All four Rounded Corners</b><br>Advantage of all four rounded corners in pouches, is they look more premium and artisan than the pointed corner ones.<br>There is always a great chance that the pointed corner in pouches can get injury to humans, as the pointed edges are very sharp like knife.</div>';
				}
				...
				if($user_admin_id['country_id'] == '42')
					    $html_pra .= '<div><b style="color:red">Note: </b>Taxes and transportation extra on above price.</div>';
				if($laser_para=='1')
				{
				...
				if($acc_para=='1')
				{
				    $html_pra .= '<div><b>All four Rounded Corners</b><br>Advantage of all four rounded corners in pouches, is they look more premium and artisan than the pointed corner ones.<br>There is always a great chance that the pointed corner in pouches can get injury to humans, as the pointed edges are very sharp like knife.</div>';
				}    
				$html_pra .= '<div><b>&nbsp;&nbsp;&nbsp;&nbsp;</b><br/>'.html_entity_decode($gettermsandconditions['termsandconditions']).'</div>';
				
		        
				//[kinjal] : changed index name on (9-4-2016)
				...
				if($cr['user']==0)
				{
					...
					//[kinjal] for pratik sir to send gress price mail on 28-4-2017
			...
			foreach($email_temp as $val)
			{
			    ...
			    /*if($_SESSION['ADMIN_LOGIN_SWISS']==7 && $_SESSION['LOGIN_USER_TYPE']==4)
			    {
			        printr($val['email']);
			        printr($message);
			        //send_email($val['email'],$formEmail,$subject,$message,'');die; //commented on 10-8-2019di
			    }
			    else
			    {*/
    			    if($n==0)
    			         send_email($val['email'],$formEmail,$subject,$message,'');
    			    else if($n==1 && in_array($toEmail, array_column($email_temp, 'email')))
    			         return '<b>'.$subject.'</b><br/><br/><fieldset>'.$val['html'].'</fieldset><br/>'.$signature;
			    //}
			}//send_email('erp@swisspac.net',$formEmail,$subject,$message,'');
		...
		$this->query("INSERT INTO `" . DB_PREFIX . "multi_product_quotation_email_history` SET multi_product_quotation_id = '".$dat['multi_product_quotation_id']."', customer_name = '".addslashes($dat['customer_name'])."', user_type_id = '" .$dat['added_by_user_type_id']. "', user_id = '" .$dat['added_by_user_id']. "', to_email = '".$toEmail."', from_email = '" .$formEmail. "',   $qstr_customer admin_default_email='".ADMIN_EMAIL."', status = '1', $qstr $pqcquery date_added = NOW()");
	
	}
	
	public function getEmailHistories($quotation_id)
	{
		$data = $this->query("SELECT qc.currency_code,qc.sec_curr,qc.sec_curr_rate,qe.date_added, qc.source, qc.currency_rate, qe.to_email FROM " . DB_PREFIX . "multi_product_quotation_email_history qe RIGHT JOIN multi_product_quotation_currency qc ON(qe.product_quotation_currency_id = qc.product_quotation_currency_id) WHERE qe.multi_product_quotation_id ='".$quotation_id."' ORDER BY qc.date_added DESC ");
		if($data->num_rows)
			return $data->rows;
		else
			return false;
	...
	{
		$sql="SELECT * FROM multi_product_quotation_id WHERE multi_product_quotation_id='".$multi_product_quotation_id_old."'";
		$data = $this->query($sql);
		
		$sql1_insert =  "INSERT INTO ".DB_PREFIX."multi_product_quotation_id SET  address_book_id = '".$data->row['address_book_id']."', date_added = NOW(),date_modify = NOW(), added_by_user_id = '".$_SESSION['ADMIN_LOGIN_SWISS']."', added_by_user_type_id = '".$_SESSION['LOGIN_USER_TYPE']."',status='".$data->row['status']."',quotation_status='".$data->row['quotation_status']."'";		
	...
	public function sendQuotationEmailInSpanish($quotation_id,$toEmail = '',$setQuotationCurrencyId='',$secondary_curr='',$sec_currency_rate=''){		
		...
		if($addedByInfo)
		{
			...
			foreach($currency_rate as $cr)
			{
				...
				$html .= '<style style="font-family: sans-serif;"> table, th, td </style>';
				$i=0;$pmq='';$c=0;$pmq_gress='';$gress='';$gp='';
				foreach($new_data as $key=>$value)
				{
					foreach($value as $size=>$qty_data)
...
Costo del Cilindro de Impresión (CON IVA) : </b> '.$pri.''.$this->numberFormate(($cylinder_price_withtax),$num_format).'<b style="color:blue"> &nbsp; '.$pri_me.'  Por Color </b></td></tr>';
					...
					if(isset($tool_price) && $tool_price>0.000)
					{
						...
						if($tool_price_withtax != '0.000')
							$html .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; Costo de Herramienta Adicional (Con IVA) : </b> '.$pri.' '.$this->numberFormate(($tool_price_withtax),$num_format).'  '.$pri_me.' <b style="color:blue"> &nbsp; Por Colour </b></td></tr>';
					}
					$html .= '<tr><td colspan="2">&nbsp;</td></tr>';
					$pmq='';
					$pmq_gress='';
				...
				$html_gress .= '<style style="font-family: sans-serif;"> table, th, td </style>';
				$i=0;$pmq='';$c=0;$pmq_gress='';$gress='';$gp='';
				foreach($new_data as $key=>$value)
				{
					foreach($value as $size=>$qty_data)
					...
					<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; Precio del Cilindro de Impresión  : </b> '.$pri.' '.$this->numberFormate(($cylinder_price),$num_format).'<b style="color:blue"> &nbsp; '.$pri_me.'  Por Color </b><br>
					                   <b>&nbsp;&nbsp;&nbsp;&nbsp; Gress Precio del Cilindro de Impresión: </b>'.$selCurrency_currency_code.' '.$this->numberFormate(($gress_cyli),$num_format).'<b style="color:blue"> &nbsp; Por Colour </b></td></tr>';
						if($cylinder_price_withtax != '0.000')
				...
				$html_gress .= '<div style="font-family: sans-serif;"><b>&nbsp;&nbsp;&nbsp;&nbsp;</b><br/>'.html_entity_decode($gettermsandconditions['termsandconditions']).'</div>';
				
				if($data[0]['shipment_country_id']=='155'){
				    $html_gress .= '<div style="font-family: sans-serif;"><b>&nbsp;&nbsp;&nbsp;&nbsp;Nota:<br/>   Las cantidades cotizadas son por cada diseño<br>
                                                                             Validez de la cotización: 15 días<br>
                                                                             Los precios anteriores causarán 16% de IVA<br>
                                                                             Los productos son entregados en nuestra bodega en la Ciudad de México.</b></div><br/><br/>';
				    
				}else{
				    $html_gress .= '<div style="font-family: sans-serif;"><b>&nbsp;&nbsp;&nbsp;&nbsp;Nota:<br/>Las cantidades cotizadas son por cada diseño.<br>
                                                                             No incluye impuestos o proceso de importación.<br>
                                                                             Entrega 8 semanas: Envío aéreo directamente hasta tu dirección.<br>
                                                                              Entrega 14 semanas aprox: envío marítimo, entrega en puerto marítimo acordado.</b></div><br/><br/>';
				}
				
                                                                             
                $html_gress .= '<div style="font-family: sans-serif;"><b style="color:red">&nbsp;&nbsp;&nbsp;&nbsp;*Más Menos (+ -):</b><b>Por favor note que en la producción comercial pueden existir variaciones en la producción final.
                                                                                                        Al final el cliente solo debe pagar la cantidad de bolsas que le será entregadas.
                                                                                                        En dicho caso si su pedido inicial es de 10.000 bolsas la producción final puede variar entre 14.500 bolsas y 6.500.
                                                                                                        Ejemplo: Si la cantidad final es de 9000 unidades, esa es la cantidad que usted deberá pagar.
                                                                                                        Si lacantidad final es 12000 unidades, esa es la cantidad que usted deberá pagar.</b></div><br/><br/>';
                                                                                                        
                
                $html_gress .= '<div style="font-family: sans-serif;"><b style="color:red">&nbsp;&nbsp;&nbsp;&nbsp;** Cilindros de Impresión:</b><b>Para las bolsas con impresión personalizada hay un costo adicional la primera vez, es el costo de los cilindros de impresión.
                                                                                                        Se necesita un cilindro por cada color que este incluido en su diseño.
                                                                                                        Así que si su diseño tiene 5 colores entonces se necesitarán 5 cilindros para la impresión de sus bolsas. 
                                                                                                        Por cada tamaño de bolsa que usted requiera se necesita juegos de cilindros diferentes ya que un juego no es ajustable a todos los tamaños.</b></div>';    
...
precio del cilindro con impuestos : </b> '.$this->numberFormate(($cylinder_price_withtax),$num_format).'<b style="color:blue"> &nbsp; Por Color </b></td></tr>';
	...
	public function addRollQuotation($data,$meter='',$menual_qty=''){
		...
		//if($_SESSION['ADMIN_LOGIN_SWISS']=='41' && $_SESSION['LOGIN_USER_TYPE']=='4')
			    //printr($data);printr($menual_qty);printr($meter);die;
			...
			if(isset($data['material']) && !empty($data['material']) && isset($data['thickness']) && !empty($data['thickness'])){
				...
				foreach($quantityArray as $key=>$eQuantity){
					...
					//START ################ TOTAL CHARGE
						...
						if($quantityInMtr > 0){
						    if( $totalKgs < 300)
						        $qty_cond = '200';
						    else if( $totalKgs >= 300 && $totalKgs < 500)
						        $qty_cond = '300';
						    else if( $totalKgs >= 500 && $totalKgs < 1000)
						        $qty_cond = '500';
						    else if( $totalKgs >= 1000 && $totalKgs < 2000)
						        $qty_cond = '1000';
						    else 
						        $qty_cond = '2000';
						}
						...
						if($transportByAir){
							...
							//[kinjal] done on 31-1-2018
							$gress_qtywise = $this->getGressQtyWise($quantity,'air',$admin_user_id,'roll');
							...
							if($quantityInMtr > 0){
								...
								$gress_qtywise = $this->getGressQtyWise($qty_cond,'air',$admin_user_id,'roll');
								
								if($gress_qtywise['percentage'] > 0){
						...
						if($transportBySea){
							...
							$pricePerUnit = 0;
							$totalPrice = 0;
							$gress_qtywise = $this->getGressQtyWise($quantity,'sea',$admin_user_id,'roll');
							...
							if($quantityInMtr > 0){
								...
								$pricePerUnit = $this->numberFormate(($totalPrice / $quantityInMtr),"5");
								$gress_qtywise = $this->getGressQtyWise($qty_cond,'sea',$admin_user_id,'roll');
								if($gress_qtywise['percentage'] > 0){
									$addingGressPrice = (($totalPrice * $gress_qtywise['percentage']) / 100);
									$test['$addingGressPrice']=$addingGressPrice.'='.$totalPrice.'+'. $gress_qtywise['percentage'].'/100';
								}
						...
						if($transportByPickup){
							$totalCharge = $this->numberFormate(($totalProfit + $totalPackingCharge),"5");
							$gress_qtywise = $this->getGressQtyWise($quantity,'pickup',$admin_user_id,'roll');
							...
							if($quantityInMtr > 0){
								...
								$totalPrice = $this->numberFormate(($totalPriceMtr + $totalCharge),"5");
								$pricePerUnit = $this->numberFormate(($totalPrice / $quantityInMtr),"5");
								$gress_qtywise = $this->getGressQtyWise($qty_cond,'pickup',$admin_user_id,'roll');
								if($gress_qtywise['percentage'] > 0){
									$addingGressPrice = (($totalPrice * $gress_qtywise['percentage']) / 100);
									$test['$addingGressPrice']=$addingGressPrice.'='.$totalPrice.'+'. $gress_qtywise['percentage'].'/100';
								}
				...
				if(isset($taxation_data) && !empty($taxation_data))
				{
					...
					if($data['normalform']=='Out Of Gujarat')
					{
						...
						$test['$cylinderpriceFortax+($cylinderpriceFortax*$taxation_cyli[igst]/100)']=$cylinderpriceFortax.'+('.$cylinderpriceFortax.'*'.$taxation_cyli['igst'].'/100)';
					...
					else
					{
						$totalcylinderpriceWithTax = $cylinderpriceFortax+($cylinderpriceFortax*($taxation_data['cgst']+$taxation_data['sgst'])/100);
						/*$totalcylinderpriceWithTax = $cylinderpriceFortax+($cylinderpriceFortax*($taxation_cyli['cgst_percentage']+$taxation_cyli['sgst_percentage'])/100);*/
						$test['$cylinderpriceFortax+($cylinderpriceFortax*($taxation_cyli[cgst]+$taxation_cyli[sgst])/100)']=$cylinderpriceFortax.'+('.$cylinderpriceFortax.'*('.$taxation_cyli['cgst'].'+'.$taxation_cyli['sgst'].')/100)';
					}
					$test['$totalcylinderpriceWithTax']=$totalcylinderpriceWithTax;
				    $test['$toolpriceFortax']=$toolpriceFortax;
				    $test['$totaltoolpriceWithTax']=$totaltoolpriceWithTax;
				...
				//quotation_type = '1', 
				$sql1 = "INSERT INTO ".DB_PREFIX."multi_product_quotation SET product_id = '".(int)$data['product']."', product_name = '".$productName."', printing_option = '".$printing_option."', printing_effect_id = '".(int)$data['printing_effect']."', printing_effect = '".$printingEffectName."', height = '".(float)$post_height."', width = '".(float)$post_width."', layer = '".(int)$totalLayer."', ink_price = '".(float)$inkPrice."', ink_solvent_price = '".(float)$inkSolventPrice."', printing_effect_price = '".(float)$printingEffectPrice."', adhesive_price = '".(float)$adhesivePrice."', cpp_adhesive = '".(int)$checkCppMaterial."', adhesive_solvent_price = '".(float)$adhesiveSolventPrice."', native_price = '".(float)$totalPrice."', use_device = '".getDevice()."', status = '0', quantity_type = '".$quantity_type."', gress_percentage = '".$userGress."',gress_air = '".$userGressAir."',gress_sea = '".$userGressSea."',packing_price = '".$originalperpouchpackingprice."', cylinder_price = '".(float)$cylinderCurrencyBasePrice."',cylinder_price_withtax='".(float)$totalcylinderpriceWithTax."', date_added = NOW(), added_by_country_id = '".$userCountry['country_id']."', currency = '".$currency."', currency_price = '".$currencyPrice."', customer_name = '".addslashes($data['customer'])."', customer_email = '".$customer_email."', customer_gress_percentage = '".$customer_gress."', shipment_country_id = '".$data['country_id']."',multi_product_quotation_id = '".$multi_product_quotation_id."', added_by_user_id = '".(int)$_SESSION['ADMIN_LOGIN_SWISS']."', added_by_user_type_id = '".(int)$_SESSION['LOGIN_USER_TYPE']."',admin_user_id='".$admin_user_id."',ink_multi_by = '".(float)$multi_by."',cust_ink_mul_by = '".$cust_ink_mul_by."' , cust_adhesive_mul_by='".$cust_adhesive_mul_by."',swiss_cylinder_rate = '".(float)$data['swiss_cylinder_rate']."', swiss_tool_rate = '".(float)$data['swiss_tool_rate']."' ";
				...
				if(isset($productQuatiationId) && (int)$productQuatiationId > 0 ){
					...
					if(isset($quantityWiseData) && !empty($quantityWiseData)){
						...
						foreach($quantityWiseData as $quantity=>$quantityValue){
							...
							$pricesql = "INSERT INTO ".DB_PREFIX."multi_product_quotation_price SET product_quotation_id = '".$productQuatiationId."', product_quotation_quantity_id = '".$productQuatiationQuantityId."', date_added = NOW(), make_pouch = '".(int)$data['make']."', zipper_txt = 'No Zip',valve_txt = 'No Valve', spout_txt = 'No Spout',accessorie_txt = 'No Accessorie',cyli_gress_price='".$cylinderCurrencyGressPrice."',gress_cyli_per='".$userInfo['gres_cyli']."',";
							...
							if(isset($taxation_data) && !empty($taxation_data))
							{
								...
								{
									$totalPriceWithTax = $totalPriceForTax+($totalPriceForTax*$taxation_data['igst']/100);
									$test['$totalPricWithExcies+($totalPricWithExcies*$taxation_data[igst_percentage]/100)']=$totalPricWithExcies.'+('.$totalPricWithExcies.'*'.$taxation_data['igst'].'/100)';
									$igst =$taxation_data['igst'];
								}
								else
								{
									$totalPriceWithTax = $totalPriceForTax+($totalPriceForTax*($taxation_data['cgst']+$taxation_data['sgst'])/100);
									$test['$totalPricWithExcies+($totalPricWithExcies*($taxation_data[cgst_percentage]+$taxation_data[sgst_percentage])/100)']=$totalPricWithExcies.'+('.$totalPricWithExcies.'*('.$taxation_data['cgst'].'+'.$taxation_data['sgst'].')/100)';
									$cgst =$taxation_data['cgst'];
									$sgst =$taxation_data['sgst'];
								}
								$test['$totalPriceWithTax']=$totalPriceWithTax;
							 ...
							 if(isset($quantityValue['BySea']) && !empty($quantityValue['BySea'])){
							//	printr($quantityValue['BySea']['userGress']);
							 ...
							 if(isset($quantityValue['ByAir']) && !empty($quantityValue['ByAir'])){
								//printr($quantityValue['ByAir']['userGress']);
								 $this->query(" $pricesql transport_type = 'air', courier_charge = '".$quantityValue['ByAir']['courierCharge']."',actual_courier_price = '".$zipData['actual_courier_price']."',fuel_charge='".$courierCharge0['fuel_charge']."',service_tax='".$courierCharge0['service_tax']."',handling_charge='".$courierCharge0['handling_charge']."', transport_price = '0', total_price = '".$quantityValue['ByAir']['totalPrice']."', gress_price = '".$quantityValue['ByAir']['addingPrice']."',gress_per = '".$quantityValue['ByAir']['userGress']."', total_charge = '".$quantityValue['ByAir']['totalCharge']."', customer_gress_price = '".$customerGressPrice."',total_price_with_tax = '".$totalPriceWithTax."', tax_type = '".$tax_type."', igst='".$igst."',cgst='".$cgst."',sgst='".$sgst."',tax_name='".$final_tax_name."'");
							}
							if(isset($quantityValue['ByPickup']) && !empty($quantityValue['ByPickup']))
							{
								//printr($quantityValue['ByPickup']['userGress']);
	...
	public function sendQuotationEmailInOtherLang($quotation_id,$toEmail = '',$setQuotationCurrencyId='',$secondary_curr='',$sec_currency_rate=''){
	    $getData = 'product_quotation_id,pq.layer, pq.added_by_user_id, pq.added_by_user_type_id, customer_name, customer_gress_percentage, customer_email, shipment_country_id, multi_quotation_number,pq.multi_product_quotation_id, quotation_type, product_id, product_name, printing_option, printing_effect, height, width, gusset,quantity_type,layer,added_by_country_id, currency, currency_id, currency_price, pq.date_added, cylinder_price,tool_price, customer_email,pq.status,discount,customer_gress_percentage,gress_percentage,gress_air,gress_sea ';
		$data = $this->getQuotation($quotation_id,$getData);
		$addedByInfo = $this->getUser($data[0]['added_by_user_id'],$data[0]['added_by_user_type_id']);
		$lang_details = $this->getLangDetails($addedByInfo['lang_id'],$data[0]['added_by_user_id'],$data[0]['added_by_user_type_id']);
		//printr($lang_details);
		foreach($data as $dat)
	    {
    		 $qdata= $this->getQuotationQuantity($dat['product_quotation_id']);
	    ...
	    $str=$product_nm_new['product_name_'.$lang_details['language']];
	    if($dat['product_id'] == '6')
	    {
	        $str=$product_nm_new['product_name_'.$lang_details['language']];
	        $product_nm_new['product_name_'.$lang_details['language']]=$lang_details['to_supplied_in_roll'];
	    }
		//151 online id and offline id is 160
		$menu_id = $this->getMenuPermission(151,$_SESSION['ADMIN_LOGIN_SWISS'],$_SESSION['LOGIN_USER_TYPE']);
		$user_admin_id=$this->getUser($_SESSION['ADMIN_LOGIN_SWISS'],$_SESSION['LOGIN_USER_TYPE']);
		...
		$first = strtoupper(substr(preg_replace('/(\B.|\s+)/','',$str),0,3));		
		$sub =$dat['multi_quotation_number'] .' - '.ucwords($dat['customer_name']).' - '.$lang_details['custom_printed'].' '.$first;
		$gussetvalue='';$s='';$sub2='';$m_k='';
		foreach($quantityData as $k=>$qty_data)
		{
			foreach($qty_data as $tag=>$qty)
			{
				...
				{   
					if($arr[0]['gusset'] == '')
					{
						$gussetval = $lang_details['no_gusset'];
					}
					else
					{
						if($dat['product_id'] == '7')
						{
							$gussetval = ' { '. $arr[0]['gusset'].'mm + '.$arr[0]['gusset'].'mm + '.$arr[0]['gusset'].'mm '.$lang_details['gusset'].' }';
						}
						elseif($arr[0]['gusset'] == '0')
						{
							 $gussetval = ' ';	
						...
						{
							$gussetval = ' { '. $arr[0]['gusset'].'mm + '.
							$arr[0]['gusset'].'mm '.$lang_details['gusset'].'}';
						}
						else if($dat['product_id'] == '10')
						{
						    $gussetval = ' { '. $arr[0]['gusset'].'mm Flap}';
					...
					if($gussetvalue=='')
						$gussetvalue=$lang_details['width'].' : '.(int)$arr[0]['width'].'mm  x '.$lang_details['height'].' : '.(int)$arr[0]['height'].'mm '.$gussetval;
					if($arr[0]['volume']=='')
						$arr[0]['volume']=$lang_details['custom'];
					
					if($dat['product_id'] != '10')
						$key=$lang_details['width'].' : '.(int)$arr[0]['width'].'mm x '.$lang_details['height'].' : '.(int)$arr[0]['height'].'mm '.$gussetval.' ['.$arr[0]['volume'].']';
					else
						$key=$lang_details['width'].' : '.(int)$arr[0]['width'].'mm x '.$lang_details['height'].' : '.(int)$arr[0]['height'].'mm '.$gussetval;
						$m_k[$arr[0]['product_quotation_quantity_id']]='';
						
					$make=$arr[0]['make_name_'.$lang_details['language']];
					$make_id=$arr[0]['make_id'];
				
					$new_data[$arr[0]['text']][$key.' ('.$arr[0]['layer'].') '][$q.'('.$arr[0]['product_quotation_quantity_id'].')'][$tag][]=$arr[0];
					if($dat['product_id'] != '10')
					{
						$zip_nm = $this->query("SELECT * FROM product_zipper WHERE zipper_name = '".$arr[0]['zipper_txt']."'");
						$val123 ='';
						if($arr[0]['valve_txt']=='With Valve')
						    $val123 = $lang_details['with_valve'];
						    
						$sub1= ' '.$zip_nm->row['zipper_name_'.$lang_details['language']].' '.$val123.''.$sub2; 
					}
					else
						$sub1= $sub2; 
				}
	    ...
	    if($addedByInfo)
		{
			...
			foreach($currency_rate as $cr)
			{
					...
					foreach($value as $size=>$qty_data)
    				{
    					...
    					foreach($qty_data as $qty=>$transport)
    					{
    						...
    						{       //printr($records);
    							...
    							$qty_type = ''; $bag_types=$lang_details['bags']; $bag_type=$lang_details['bag'];
    							if($dat['product_id'] == '6'){
    							    $bag_type = $qty_type = $records[0]['quantity_type'];$bag_types = $records[0]['quantity_type'].'s';}
    							...
    							if($dat['product_id'] != '10')
    								$bag= $lang_details['plus_or_minus'].' '.$plus_minus_quantity.' '.$bag_types;
    							else
    								$bag='';
    								
    							if($k=='air')
    							{
    								$txt_tarnsport='( '.$lang_details['express_delivery'].' )';
    							}
    							if($k=='sea')
    							{
    								$txt_tarnsport='( '.$lang_details['normal_delivery'].' )';
    							}
    						    ...
    						    $pmq .= '<tr valign="top"><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$lang_details['price'].': </b>'.$selCurrency_currency_code.' '.$this->numberFormate($extra_profit ,$num).' '.$lang_details['per_1'].' '.$bag_type.' '.$taxvalue.'<b> { '.$lang_details['for_pouch'].' '.$qty.' '.$bag_types.' '.$design.''.$bag.' }</b>&nbsp;<span style="color:'.$color.'"> -  '.$txt_tarnsport.'. '.$tax_str.'</span><br><br></td></tr>';	
    							if(isset($records[0]['discount']) && $records[0]['discount']>0.000)							
    							{
    								if($dat['product_id'] != '10')
    									$bag= $lang_details['plus_or_minus'].' '.$plus_minus_quantity.' '.$bag_types.' '.$design;
    								else
    									$bag='';
    								$pmq .='<tr valign="top"><td width="20px">&nbsp;</td><td><b>'.$lang_details['discount'].' ('.$records[0]['discount'].' %): </b>'.$dat['currency'].' '.$this->numberFormate($extra_profit ,$num).' '.$lang_details['per_1'].' '.$bag_type.' '.$taxvaluedis.'<b> { '.$lang_details['for_pouch'].' '.$qty.' '.$bag_types.' '.$design.''.$bag.' }</b>&nbsp;<span style="color:'.$color.'"> -  '.$txt_tarnsport.'. '.$tax_str.'</span></td></tr>';
    							}
    							
    						}
        					$m ='<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['make_up_pouch'].': ';
        					if($dat['product_id'] == '6')
        					    $m='<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['make_up_pouch_rolls'].': ';	
        						
        					if($lang_details['lang_id']!='27')
        					    $m .=' </b> '.$lang_details['custom_printed'].' '.$product_nm_new['product_name_'.$lang_details['language']];
        					else
        					    $m .=' </b> '.$product_nm_new['product_name_'.$lang_details['language']].' '.$lang_details['custom_printed'].' ';
        					
        					if($dat['product_id'] != '10' && $dat['product_id'] != '6')
        						$m.=str_replace('<br>',' ',$records[0]['txt_lang']);
        					if($dat['product_id'] == '6')
        					    $m.='&nbsp;&nbsp;'.$lang_details['make_up_pouch_rolls'].' - '.$records[0]['make_name_'.$lang_details['language']].'</td></tr>';
        					else
        					    $m.='&nbsp;&nbsp;'.$lang_details['make_up_pouch'].' - '.$records[0]['make_name_'.$lang_details['language']].'</td></tr>';
        					
    					}
    					$html .='<tr><td colspan="2"><b>'.($i+1).'&nbsp;&nbsp;&nbsp; '.$lang_details['size'].': </b>'.$size.'</td></tr> ';
    					$html .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['material'].': </b>';
    					$materialData = $this->getQuotationMaterial($records[0]['materialData'][0]['product_quotation_id']);
    					//printr($materialData);
    					if(isset($materialData) && !empty($materialData))
    					{
    						...
    						for($gi=0;$gi<count($materialData);$gi++)
							{
								$mat_nam = $this->query("SELECT * FROM product_material WHERE product_material_id = '".$materialData[$gi]['material_id']."'");
								if($materialData[$gi]['material_id'] == '8')
									$materialStr .= '6 to '.(int)$materialData[$gi]['material_thickness'] .' mic '. $mat_nam->row['material_name_'.$lang_details['language']] .' / ';
								else
									$materialStr .= (int)$materialData[$gi]['material_thickness'] .' mic '. $mat_nam->row['material_name_'.$lang_details['language']] .' / ';
							}
    						$html .= ''.substr($materialStr,0,-3).' </td>';
    					}
    					...
    					$materialData='';
    					$html .= '</tr>';
    					$html .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['shipment_country'].': </b>'.$shippingCountry['country_name'].'</td></tr>';
    					$html .=$m;
    					if($records[0]['gusset_printing_type']=='Front & Back  +  No Gusset Printing')
    						$records[0]['gusset_printing_type']= $lang_details['f&b&no'];
    					elseif($records[0]['gusset_printing_type']=='Front & Back + Side Gusset Printing')	
    					    $records[0]['gusset_printing_type']= $lang_details['f&b&side'];
    					elseif($records[0]['gusset_printing_type']=='Front & Back + Bottom / Side Gusset Printing')
    				    	$records[0]['gusset_printing_type']= $lang_details['f&b&side&bottom'];
    					else
    						$records[0]['gusset_printing_type']= $lang_details['f&b&bottom'];
    					
    					$effe_nam = $this->query("SELECT * FROM printing_effect WHERE effect_name LIKE '%".$records[0]['printing_effect']."%'");
    					$html .='<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['printing_effect'].': </b>'.$effe_nam->row['effect_name_'.$lang_details['language']].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>';
    					
    					if($records[0]['gusset_printing_type']!='' && $dat['product_id'] != '6')
    					  $html .='<br/>'.$lang_details['gusse_printing_type'].': '.$records[0]['gusset_printing_type'];
    					  
    					 $html .='</td></tr>';
    				    if($lang_details['your_client_price']!='')	 
    					    $txt='['.$lang_details['your_client_price'].']';
    					...
    					$html .=$pmq_gress;
    						...
    						$html .= '<tr><td colspan="2">&nbsp;</td></tr>
    					              <tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['cylinder_price'].': </b>'.$selCurrency_currency_code.' '.$this->numberFormate(($cylinder_price),$num_format).'<b style="color:blue"> &nbsp; '.$lang_details['per_color'].' </b></td></tr>';
    						if($cylinder_price_withtax != '0.000')
    							$html .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp;'.$lang_details['cylinder_price_with_tax'].': </b>'.$selCurrency['currency_code'].' '.$this->numberFormate(($cylinder_price_withtax),$num_format).'<b style="color:blue"> &nbsp; '.$lang_details['per_color'].' </b></td></tr>';
    					...
    					if(isset($tool_price) && $tool_price>0.000)
    					{
    						...
    						$html .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['extra_tool_price'].': </b>'.$selCurrency_currency_code.' '.$this->numberFormate(($tool_price),$num_format).'. '.$lang_details['tool_note'].'</td></tr>';
    						if($tool_price_withtax != '0.000')
    							$html .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['extra_tool_price_with_tax'].': </b>'.$selCurrency['currency_code'].' '.$this->numberFormate(($tool_price_withtax),$num_format).'<b style="color:blue"> &nbsp; '.$lang_details['per_color'].' </b></td></tr>';
    					}
    					$html .= '<tr><td colspan="2">&nbsp;</td></tr>';
    					$pmq='';
    					$pmq_gress='';
				...
				if($laser_para=='1')
				{
				    $html .= $lang_details['with_laser_note'];
				}
				if($acc_para=='1')
				{
				    $html .= $lang_details['acc_round_corner_note'];
				}    
				if($lang_details['termsandconditions']!='')
				    $html .= '<br><div><b>&nbsp;&nbsp;&nbsp;&nbsp;</b>'.html_entity_decode($lang_details['termsandconditions']).'</div>';
				if($lang_details['pay_terms']!='' && $addedByInfo['country_id'] != '155' )
				    $html .= '<br><div><b>&nbsp;&nbsp;&nbsp;&nbsp;</b>'.html_entity_decode($lang_details['pay_terms']).'</div>';
				...
				if($addedByInfo['country_id'] == '155')
				{
    				...
    				{
    				    $html_gress .=html_entity_decode($lang_details['pay_terms']);
    				}
    				$html_gress .= '<div style="font-family: sans-serif;"><b style="color:red">&nbsp;&nbsp;&nbsp;&nbsp;*Más Menos (+ -):</b><b>Por favor note que en la producción comercial pueden existir variaciones en la producción final.
                                                                                                        Al final el cliente solo debe pagar la cantidad de bolsas que le será entregadas.
                                                                                                        En dicho caso si su pedido inicial es de 10.000 bolsas la producción final puede variar entre 14.500 bolsas y 6.500.
				    ...
				    foreach($value as $size=>$qty_data)
    				{
    					...
    					foreach($qty_data as $qty=>$transport)
    					{
    						...
    						foreach($transport as $k=>$records)
    						{
    							...
    							if(!empty($menu_id) || !empty($menu_admin_permission))
    						    {
    						        $gress = '<tr><td colspan="2" >&nbsp;</td></tr><tr valign="top"><td width="60" colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['gress_per_price'].':'.$txt.'</b></td></tr>';								
    								$newPircegress = ((($records[0]['totalPrice'] - $records[0]['customerGressPrice'] - $records[0]['gress_price']) / (float)$dat['currency_price']) / (float)$cr['currency_rate'] );
    								$newPircegress = $newPircegress/$qty;
    								$taxvaluegress='';
    								...
    								$pmq_gress .= '<tr valign="top"><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$lang_details['price'].': </b>'.$selCurrency_currency_code.' '.$this->numberFormate($newextra_profit ,$num).' '.$lang_details['per_1'].' '.$bag_type.' '.$taxvaluegress.'<b> { '.$lang_details['for_pouch'].' '.$qty.' '.$bag_types.' '.$bag.' }</b>&nbsp;<span style="color:'.$color.'"> - '.$txt_tarnsport.'. '.$tax_str.' at GP '.$gp.' % </span><br><br></td></tr>';	
    								if(isset($records[0]['discount']) && $records[0]['discount']>0.000)
    								{
    									$pmq_gress .='<tr valign="top"><td width="20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>'.$lang_details['discount'].' ('.$records[0]['discount'].' %): </b></td><td>'.$dat['currency'].' '.$this->numberFormate($newextra_profit ,$num).' '.$lang_details['per_1'].' '.$bag_type.' '.$taxvaluedisgress.'<b> { '.$lang_details['for_pouch'].' '.$qty.' '.$bag_types.' '.$bag.' }</b>&nbsp;<span style="color:'.$color.'"> - '.$txt_tarnsport.'. '.$tax_str.' at GP '.$gp.' % </span></td></tr>';
    								}
    						    }
    							$newPirce = ((($records[0]['totalPrice'] + $records[0]['customerGressPrice']) / (float)$dat['currency_price']) / (float)$cr['currency_rate'] );
    							$newPirce = $newPirce/$qty;
    							...
    							$pmq .= '<tr valign="top"><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$lang_details['price'].': </b>'.$selCurrency_currency_code.' '.$this->numberFormate($extra_profit ,$num).' '.$lang_details['per_1'].' '.$bag_type.' '.$taxvalue.'<b> { '.$lang_details['for_pouch'].' '.$qty.' '.$bag_types.' '.$bag.' }</b>&nbsp;<span style="color:'.$color.'"> -  '.$txt_tarnsport.'. '.$tax_str.'</span></td></tr>';	
    							if(isset($records[0]['discount']) && $records[0]['discount']>0.000)							
    							{
    								$pmq .='<tr valign="top"><td width="20px">&nbsp;</td><td><b>'.$lang_details['discount'].' ('.$records[0]['discount'].' %): </b>'.$dat['currency'].' '.$this->numberFormate($extra_profit ,$num).' '.$lang_details['per_1'].' '.$bag_type.' '.$taxvaluedis.'<b> { '.$lang_details['for_pouch'].' '.$qty.' '.$bag_types.' '.$bag.' }</b>&nbsp;<span style="color:'.$color.'"> -  '.$txt_tarnsport.'. '.$tax_str.'</span></td></tr>';
    							}
    					...
    					$html_gress .='<tr><td colspan="2"><b>'.($i+1).'&nbsp;&nbsp;&nbsp; '.$lang_details['size'].': </b>'.$size.'</td></tr> ';
    					$html_gress .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['material'].': </b>';
    					$materialData = $this->getQuotationMaterial($records[0]['materialData'][0]['product_quotation_id']);
    					if(isset($materialData) && !empty($materialData))
    					{
    						$materialStr = '';
    					...
    					$materialData='';
    					$html_gress .= '</tr>';
    					$html_gress .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['shipment_country'].': </b>'.$shippingCountry['country_name'].'</td></tr>';
    					...
    					$effe_nam = $this->query("SELECT * FROM printing_effect WHERE effect_name LIKE '%".$records[0]['printing_effect']."%'");
    					$html_gress .='<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['printing_effect'].': </b>'.$effe_nam->row['effect_name_'.$lang_details['language']].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>';
    				
    					if($records[0]['gusset_printing_type']!='' && $dat['product_id'] != '6')
    					  $html_gress .='<br/>'.$lang_details['gusse_printing_type'].' : '.$records[0]['gusset_printing_type'];
    					 ...
    					 if($lang_details['your_client_price']!='')
    						...
    						{
        						$html_gress .= '<tr><td colspan="2">&nbsp;</td></tr>
        					<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['cylinder_price'].': </b>'.$selCurrency_currency_code.' '.$this->numberFormate(($cylinder_price),$num_format).'<b style="color:blue"> &nbsp; '.$lang_details['per_color'].' </b><br>
        					                   <b>&nbsp;&nbsp;&nbsp;&nbsp; Cylinder Gress price: </b>'.$selCurrency_currency_code.' '.$this->numberFormate(($gress_cyli),$num_format).'<b style="color:blue"> &nbsp; '.$lang_details['per_color'].' </b></td></tr>';
        						if($cylinder_price_withtax != '0.000')
        							$html_gress .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['cylinder_price_with_tax'].': </b>'.$selCurrency['currency_code'].' '.$this->numberFormate(($cylinder_price_withtax),$num_format).'<b style="color:blue"> &nbsp; '.$lang_details['per_color'].' </b></td></tr>';
    						}
        					if(isset($tool_price) && $tool_price>0.000)
        					{
        						...
        						$html_gress .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['extra_tool_price'].': </b>'.$selCurrency_currency_code.' '.$this->numberFormate(($tool_price),$num_format).'. '.$lang_details['tool_note'].'</td></tr>';
        						if($tool_price_withtax != '0.000')
        							$html_gress .= '<tr><td colspan="2"><b>&nbsp;&nbsp;&nbsp;&nbsp; '.$lang_details['extra_tool_price_with_tax'].': </b>'.$selCurrency['currency_code'].' '.$this->numberFormate(($tool_price_withtax),$num_format).'<b style="color:blue"> &nbsp; '.$lang_details['per_color'].' </b></td></tr>';
        					}
        					$html_gress .= '<tr><td colspan="2">&nbsp;</td></tr>';
        					$pmq='';
        					$pmq_gress='';
				...
				if($laser_para=='1')
				{
				    $html_gress .= $lang_details['with_laser_note'];
				}
				if($acc_para=='1')
				{
				    $html_gress .= $lang_details['acc_round_corner_note'];
				}
				if($lang_details['termsandconditions']!='')
				    $html_gress .= '<br><div><b>&nbsp;&nbsp;&nbsp;&nbsp;</b><br/>'.html_entity_decode($lang_details['termsandconditions']).'</div>';
			    if($lang_details['pay_terms']!='')
				    $html_gress .= '<br><div><b>&nbsp;&nbsp;&nbsp;&nbsp;</b><br/>'.html_entity_decode($lang_details['pay_terms']).'</div>';
			...
			foreach($email_temp as $val)
			{
			    ...
			    send_email($val['email'],$formEmail,$subject,$message,'');//die;
			}
			//send_email('erp@swisspac.net',$formEmail,$subject,$message,'');die;
		}
	}
}
?>