                                          	...
                                          	<?php $i=1;
												...
												?>
                                                            <tr id="quotation-row-<?php echo $soption['product_quotation_price_id']; ?>">
                                                                    ...
                                                                    <td><?php echo $soption['dimension'].' ( <b>'.$soption['make_name'].'</b> )<br><br><b style="color:#0066CC"> Plate Price :'.$soption['quantity_data']['color_plate_price']. '</b><br></br> <b style="color:#0066CC"> Gress Plate Price :'.$soption['quantity_data']['gress_color_plate_price'].'</b>'; ?></td>
                                                                   

                                                                    <td><?php echo $soption['quantity_data']['price'].' '.$soption['quantity_data']['currency_code'];?> 
                                                                        <?php echo '<br><b style="color:red;">(Selling Price / '.$soption['quantity_data']['stock_print'].')</b><br><br>'.$soption['quantity_data']['gress_pouch_price'].' '.$soption['quantity_data']['currency_code'].'<br><b style="color:blue;">(Gress Selling Price / '.$soption['quantity_data']['stock_print'].')';?></td>
