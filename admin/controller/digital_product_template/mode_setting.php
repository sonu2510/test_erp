...
//// add By Sonu 17-03-2018
	$table = 'digital_product_template'; 
	$rout = 'digital_product_template';
	...
	define('CLONE_WARNING','Are you sure Clone selected item.');
	...
	$display_name = 'Template Order';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/digital_product_template.php');
	$obj_template = new digital_product_template;
?>