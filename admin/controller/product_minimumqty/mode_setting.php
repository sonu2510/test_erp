<?php
	$table = 'product_minimumqty'; 
	$rout = 'product_minimumqty';
	...
	$display_name = 'Product Minimum Quantity Master ';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/product_minimumqty.php');
	$obj_qty = new product_minimumqty;
?>
