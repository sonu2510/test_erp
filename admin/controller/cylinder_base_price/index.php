        ...
        <section class="panel">
          <header class="panel-heading bg-white"> 
          	...
          	<span class="text-muted m-l-small pull-right">
   				...
   				<a class="label bg-primary" href="<?php echo $obj_general->link($rout, 'mod=add', '',1);?>">
                   	<i class="fa fa-plus"></i> New Cylinder Base Price
                </a>
          	...
          	<div class="table-responsive">
                <table class="table table-striped b-t text-small">
                  ...
                  if($total_cyliners){
                      ...
                      $option = array(
                            'sort'  => 'product_cylinder_base_price_id',
                            'order' => 'ASC',
                            'start' => ($page-1)*LISTING_LIMIT,
                            'limit' => LISTING_LIMIT
                      );	

                      $productCylinders = $obj_cylinder->getProductCylinders($option);
					  ...
					  foreach($productCylinders as $cylinder){ 
                        ...
                        <tr>
                          ...
                          <td><?php echo $cylinder['currency_code']; ?></td>
                          <td>
                                <a href="<?php echo $obj_general->link($rout, 'mod=add&cylinder_id='.encode($cylinder['product_cylinder_base_price_id']), '',1); ;?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
