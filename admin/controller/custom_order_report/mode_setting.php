<?php
	$table = 'custom_order_report'; 
	$rout = 'custom_order_report';
	...
	$display_name = 'custom order report';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/custom_order_report.php');
	$obj_custom = new custom_order_report ;
?>
