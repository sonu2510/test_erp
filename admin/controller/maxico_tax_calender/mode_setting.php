<?php
	$table = 'maxico_tax_calender'; 
	$rout = 'maxico_tax_calender';
	...
	$display_name = 'Mexico Tax Calender';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/maxico_tax_calender.php');
	$obj_tax_calender = new maxicoTaxCalender ;
?>
