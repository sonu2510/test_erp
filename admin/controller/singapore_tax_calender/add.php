...
if(isset($_GET['tax_sin_calender_id']) && !empty($_GET['tax_sin_calender_id'])){
	if(!$obj_general->hasPermission('edit',$menuId)){
		$display_status = false;
	}else{
		$tax_sin_calender_id = base64_decode($_GET['tax_sin_calender_id']);
		$tax_record = $obj_tax_calender->getTaxRecord($tax_sin_calender_id);
		$tax_record_img = $obj_tax_calender->getTaxImgRecord($tax_sin_calender_id);
...
if($display_status){
	...
	if(isset($_POST['btn_update']) && $edit){
		...
		//printr($post);die;
		$tax_sin_calender_id = $tax_record['tax_sin_calender_id'];
		$obj_tax_calender->updateTax($tax_sin_calender_id,$post);
                                             ...
                                             <tbody class="tbody">
                                                <?php  $i=1;
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td> <a class="label bg-danger remove" style="margin-left:4px;" onclick="remove_record(<?php echo $img_result['sin_image_id'];?>,<?php echo $i; ?>)"><i class="fa fa-trash-o"></i> Remove</a></td>
                                                  </tr>             
                                                       <?php $i++;
													    }
													  } ?>     
