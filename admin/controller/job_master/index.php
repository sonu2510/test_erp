          	...
          	<div class="table-responsive">
				...
				//	    printr($country_name.'  '.$job['country_id']);
					//  printr($country_name);
                        ?>
                        <tr >
                          <td><input type="checkbox" name="post[]" value="<?php echo $job['job_id'];?>"><br><span style="color:#f92c09" ><?php echo dateFormat(4,$job['job_date']);  ?></span></td>
						  ...
						  <?php if($job['lamination_status']=='0' && $job['m_process']==3){?>
						   <a href="<?php echo $obj_general->link('lamination_process', 'mod=add&job_id='.encode($job['job_id']),'',1); ?>"   class="btn btn-info btn-xs">Go For Lamination</a>
						  <?php }
