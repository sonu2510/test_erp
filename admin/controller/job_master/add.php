          ...
          <div class="panel-body">
            ...
            <!-- manirul 11-2-17 -->
                                 ...
                                 if(isset($job_dieline) && !empty($job_dieline)) {
									  ...
									  $html .='<div class="carousel slide auto" id="c-slide-'.$job_id.'" style="width: 150px;">
										...
										foreach($job_dieline as $image){
											...
											$html .='<img class="" style="padding-left: 13px;float: right;margin-left: -16px; " alt="Image" width="30" height="10" src="'.HTTP_UPLOAD.'admin/dielineForJob/d1.png" onClick="removefile('.$image['job_dieline_id'].')">';
											if($ext!='pdf')
											{
                                            	$html .='<p class="text-center"><a href="'.HTTP_UPLOAD.'admin/dielineForJob/'.$image['job_name'].'" target="_blank"><img class="" alt="Image" width="100" height="100" src="'.HTTP_UPLOAD.'admin/dielineForJob/'.$image['job_name'].'"></a></p><center><a href="'.HTTP_UPLOAD.'admin/dielineForJob/'.$image['job_name'].'" target="_blank">'.$image['job_name'].'</a></center>';
			  ...
			  <div class="form-group">
				...
				<div class="col-lg-4">
				  <select name="country_id" id ="country_id" onchange="get_user_details()" class="form-control validate[required]">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-lg-3 control-label"><span class="required">*</span> Qty(Kgs)</label>
                <div class="col-lg-4">
                  	<input type="text" name="no_of_pouch_kg" value="<?php echo isset($job['no_of_pouch_kg'])?$job['no_of_pouch_kg']:'';?>" class=  "form-control">
