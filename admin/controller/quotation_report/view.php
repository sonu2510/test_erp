    ...
    <div class="row">
      ...
      <div class="col-sm-12">
            ...
            <header class="panel-heading bg-white">
                 <span> Multi Quotation Report Detail </span>
            ...
            <?php /*?> <div> Searching Date From:  <b> <?php echo dateFormat(4,$post['f_date']); ?></b>   To: <b>  <?php echo dateFormat(4,$post['t_date']);?></b> </div>
             ...
             <div class='panel-body'>
              ...
              <?php 
			  	$html = $obj_quotation->view_quotation_report($multi_quotation_details,$post);
				echo $html;
			  ?>
...
<style>
#quotation_order tbody tr{cursor: pointer; }
</style>
...
<script type="application/javascript">
	...
	var add_product_url = getUrl("<?php echo $obj_general->ajaxLink($rout, '&mod=ajax&fun=quotation_data', '',1);?>");
...
$(document).ready(function(){
    $('#quotation_order tbody tr').click(function(){
