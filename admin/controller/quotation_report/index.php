...
if($display_status) {
$total_stock_order = $obj_quotation->getUserList('');
          ...
          <div class="panel-body"></div>
			 ...
			 { ?>
                      <div class="form-group">
                        ...
                        <div class="col-lg-3">
                        <?php $userlist = $obj_quotation->getUserList(); ?>
             ...
             <?php } ?>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-lg-3">
                <?php $products = $obj_quotation->getProducts();?>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-3">
                <?php $countries = $obj_quotation->getCountry();?>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-3">
                <?php //$date_status = $obj_quotation->getStatus();?>
					<select class="form-control" name="transport_type" >
                        <!--<option value="">Select By</option>-->
                         <option value="">Select Transportation</option>
                         <option value="air">By Air</option>
                         <option value="sea">By Sea</option>
                         <option value="pickup">By Pickup</option>
