           ...
           <input type="hidden" id="action" name="action" value="" />
          	<div class="table-responsive">
                <table id="quotation-row" class="table b-t text-small table-hover">
                  ...
                  $total_quotation = $obj_quotation->getTotalQuotation($obj_session->data['LOGIN_USER_TYPE'],$obj_session->data['ADMIN_LOGIN_SWISS'],$filter_data,$cond,$add_book_id);
                  ...
                  if($total_quotation!=0){
                      ...
                      $option = array(
                       ...
                       $quotations = $obj_quotation->getQuotations($obj_session->data['LOGIN_USER_TYPE'],$obj_session->data['ADMIN_LOGIN_SWISS'],$option,$filter_data,$add_book_id);	
