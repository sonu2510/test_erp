...
if(isset($_GET['quotation_id']) && !empty($_GET['quotation_id'])){
	if(!$obj_general->hasPermission('edit',$menuId)){
		...
		$getData = ' pq.swiss_cylinder_rate,pq.swiss_tool_rate,product_quotation_id, pq.added_by_user_id, pq.added_by_user_type_id, customer_name, shipment_country_id, quotation_type, quantity_type, product_id, product_name, printing_option, printing_effect, height, width, gusset, layer, currency, currency_price, cylinder_price, customer_gress_percentage,pq.status,pq.quotation_status,valve_price';
                 ...
                 <span class="text-muted m-l-small pull-right">
              	...
              	<div class="panel-body" id="">
                    ...
                    <span class="text-muted m-l-small pull-right">
                     ...
                     <?php if($user_id =='1' && $user_type_id =='1'){ //printr($data);
                             ...
                             <?php }
                                   ...
                                   { ?><br />
                                    	...
                                    	Product Conversion Rate  : <b><?php echo 'INR : '.$data[0]['currency_price'];?></b>
                                            ...
                                            <br />
                                             <span class="text-muted m-l-small pull-right">
                                            	Cylinder Conversion Rate  : <b><?php echo 'INR : '.$data[0]['swiss_cylinder_rate'];?></b>
                                            </span>
                                            <br />
                                             <span class="text-muted m-l-small pull-right">
                                            	Tool Conversion Rate  : <b><?php echo 'INR : '.$data[0]['swiss_tool_rate'];?></b>
                                            </span>
                              <?php }
                            }?>
                        ...
                        ?>
                          <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                          ...
                                          <div class="table-responsive">
                                                                ...
                                                                <td >
                                                                   ...
                                                                   if($soption['spout_txt'] != 'No Spout')
                                                                   {
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        /*printr($newprice.'/'.$soption['gress_price']);
                                                                        printr($soption['totalPrice'].'/'.$skey);
                                                                    ...
                                                                    <td><?php echo (int)$soption['width'].'X'.(int)$soption['height'].'X'.(int)$soption['gusset']; if($data[0]['product_id']!=10){if($soption['volume']!='') echo ' <b>('.$soption['volume'].')</b>'; else echo ' (Custom)';}?>
																 	...
																 	/*if($soption['make_id']=='6')
																	{
																		 ...
																		 {		
																				if($soption['materialData'][$gi]['material_id']!='16' && $soption['make_id']=='6')
																				 {//printr($soption['materialData'][$gi]['material_id']);
																				 	if($j=='2')
																					{//printr($soption['materialData'][$gi]['material_id']);
											...
											//Calculated Layer Price : '.$soption['materialData'][$gi]['layer_wise_price'].'	  
												...
												//Calculated Layer Price : '.$soption['materialData'][$gi]['layer_wise_price'].'	  
                                                                    ...
                                                                    if($k=='air') {?>
                                                                    <td>
                                                   <?php echo '<b>'.$soption['courier_charge'].'</b><br><br> <b style="color:#0066CC"> Courier Charge With Tax Per KG: ';
										...
										echo '<br> <b style="color:#0066CC">Basic Courier Price  Per KG : '.$soption['actual_courier_price'].' </b><br>' ;
										 ...
										 ?>
                                                                ...
                                                                if(isset($soption['zipper_option']['spout_price'])){
                                                                    echo '<b>'.$soption['spout_txt'].'  : </b>'.$soption['zipper_option']['spout_price'].'<br>';
                                                                }
                                                                if(isset($soption['zipper_option']['accessorie_price'])){
                                                                   // $slider= '';
                                                                    //if($soption['accessorie_txt_corner']=='Normal Slider' || $soption['accessorie_txt_corner']=='Child Resistance Slider')
                                                                        //$slider = 'Slider';
                                                                    echo '<b> '.$soption['accessorie_txt'].' Acc  : </b>'.$soption['zipper_option']['accessorie_price'].'<br>';
																	if($soption['zipper_option']['accessorie_price_corner'] != 0)
																	{
																		echo ' + <b>'.$soption['accessorie_txt_corner'].' : </b>'.$soption['zipper_option']['accessorie_price_corner'].'<br>';
																	}
                                                                }
                                                                
                                                                if(strchr($soption['text'],"Tin"))
                                                                {
                                                                    echo '<b>'.$soption['zipper_txt'].'  : </b>'.$soption['zipper_option']['zipper_price'].'<br>';
                                                                }
                                                                else
                                                                {
                                                                    echo '<b>'.$soption['zipper_txt'].'  : </b>'.$soption['zipper_option']['zipper_price'].'<br>';
                                                                }
                                                                    echo '<b>'.$soption['valve_txt'].' Price :</b>'.$soption['zipper_option']['valve_price'];
                                                                    
                                                                    echo '<br><br><b>'.$soption['laser_type'].' Price:</b>'.$obj_quotation->numberFormate(($soption['width']*$soption['laser_price']/100),"3");
                                                                   
                                                                   if($data[0]['product_id'] == '55' || $data[0]['product_id'] == '56' || $data[0]['product_id'] == '57')
																		echo '<br><br><b>'.$soption['handle_name'].' Price:</b>'.$soption['handle_price'];
                                                                    ?>
																	 ...
																	 if($data[0]['product_id']=='6')
																	    $soption['packing_price'] = $soption['packing_base_price'];
