...
if(isset($_POST['btn_pro'])){
		$post = post($_POST);
			//printr($post);
			$job_id=$post['job_id'];
			$calculationforjob= $obj_job_report-> getjob_report_cal_job($job_id);
			$data = $obj_job_report-> getjob_report($job_id);
            ...
            <section class="panel">  
              ...
              <div class="panel-body">
                 ...
                 <form class="form-horizontal" method="post" name="form" id="form" enctype="multipart/form-data">
                       ...
                       <div> 
                 	  <div class="form-group"><h1>JOB REPORT</h1> </div></div>
...
function wordlink(id){
		...
		var url = '<?php echo HTTP_SERVER.'word/job_report.php?mod='.encode('job_report').'&ext='.md5('php');?>&token='+id;
	...
	$(".pdfcls").click(function(){			
				...
				var url = '<?php echo HTTP_SERVER.'pdf/job_reportpdf.php?mod='.encode('job_report').'&token='.rawurlencode(encode($job_id)).'&ext='.md5('php').'&num=0';?>';				
