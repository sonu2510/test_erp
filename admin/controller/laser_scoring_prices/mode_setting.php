<?php
	$table = 'laser_scoring_prices'; 
	$rout = 'laser_scoring_prices';
	...
	$display_name = 'Laser Scoring Prices';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/laser_scoring_prices.php');
	$laser_prices = new laser_scoring_prices;
?>