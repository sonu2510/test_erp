...
{	if(!$obj_general->hasPermission('edit',$menuId)){
		...
		$obj_digital_printing->updateStatus($status,$_POST['post']);
                  ...
                  if($total_job){
                      ...
                      $option = array(
                          ...
                          'limit' => $limit
						   ...
						   $jobs = $obj_digital_printing->getDateWiseJob($filter_data);
						 //printr($jobs);
					...
					//  printr($job);
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo $obj_general->link($rout,'mod=index&job_date='.encode($job['digital_printing_date']),'',1); ?>" ><?php echo dateFormat(4,$job['digital_printing_date']);  ?></a></td>
