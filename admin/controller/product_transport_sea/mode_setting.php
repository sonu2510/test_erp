<?php
	$table = 'product_transport_sea_height'; 
	$rout = 'product_transport_sea';
	...
	$display_name = 'Transport Sea List';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/product_transport_sea.php');
	$obj_sea_transport = new productTransportSea;
?>