												...
												<header class="panel-heading" style="border-color: #8CED9C;background: #D2FFE5;"> 
												 ...
												 <span class="label bg-success" style="font-size: 100%;"><?php echo $order['gen_order_id'];?></span>
													...
													<?php if($order['shipment_country']=='252'){?>
												         <span class="label bg-success" style="font-size: 100%;margin-center:20px"><?php echo 'Reference No :'.$order['reference_no'];?></span><?php  } ?>
											   ...
											   if($menu_id OR $obj_session->data['LOGIN_USER_TYPE']==1){?>
												...
												<div class="panel-body clearfix tab-pane fade active in" id="detail_<?php echo $f;?>" style="display:block;">
													<div id="collapseOne" class="panel-collapse in"> 
														<div class="panel-body text-small" style="width:25%;float: left;"><b>Option : </b><?php echo $order['zipper'].' '.$order['valve'].' '.$order['spout'].' '.$order['accessorie'].' '.$order['accessorie_txt_corner'].'<br><b>Dimension (Size) : </b>'.$order['width'].'X'.$order['height'].'X'.$order['gusset'].' <span style="color:red;font-weight:bold">('.$order['volume'].')</span><br><b>Color : </b>'.$order['color'].'<br><b>Order Date :</b>'.dateFormat(4,$order['date_added']); ?>
														</div>
														...
														echo '<br><b>Dispatched Date : </b>'.dateFormat(4,$order['date']);
