                                             ...
                                             <span class="label bg-warning" style="font-size: 100%;"><?php echo $order['gen_order_id'];?></span>    
												...
												<?php echo preg_replace("/\([^)]+\)/","",$order['product_name']);?></span>
                                                  <?php if($order['shipment_country']=='252'){?>
												         <span class="label bg-success" style="font-size: 100%;margin-left:30px; background:#FFC800;"><?php echo 'Reference No :'.$order['reference_no'];?></span><?php  } ?>
                                            </header> 
										  ...
										  if($multi_custom_order_id=='')
										  {
                                            ...
                                            <div class="panel-body clearfix tab-pane fade active in detail" id="detail_<?php echo $f;?>" style="display:block;">
                                               <div id="collapseOne" class="panel-collapse in"> 
                                                    <div class="panel-body text-small" style="width:35%;float: left;"><b>Option : </b><?php echo $order['zipper'].' '.$order['valve'].' '.$order['spout'].' '.$order['accessorie'].' '.$order['accessorie_txt_corner'].'<br><b>Dimension (Size) : </b>'.$order['width'].'X'.$order['height'].'X'.$order['gusset'].'<span style="color:red;font-weight:bold"> ('.$order['volume'].')</span><br><b>Color : </b>'.$order['color'].'<br><b>Order Date :</b>'.dateFormat(4,$order['date_added']); ?>
                                                    </div>
												   ...
												   <?php if(isset($obj_session->data['ADMIN_LOGIN_USER_TYPE']) && $obj_session->data['ADMIN_LOGIN_USER_TYPE'] != '')
                                                      ...
                                                      <?php }
														...
														?>
                                                            ...
                                                            value="Decline" onclick="review(<?php echo $f;?>,<?php echo $order['template_order_id']?>,<?php echo $order['product_template_order_id']?>,<?php echo $order['client_id']?>,<?php echo $order['quantity']-$dis_qty['total_dis_qty']; ?>)" class="btn btn-danger"> 
                                                        </div>    
   													<?php }?>                                       
    											</div>
    										</div> 
