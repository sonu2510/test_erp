          ...
          <header class="panel-heading bg-white"> 
           ...
           <input type="hidden" id="action" name="action" value="" />
                  ...
                  <?php
					...
					//printr($orders);
					// die;
					 foreach($orders as $order){ //printr($order); ?>
                   ...
                   <div class="panel-body clearfix" > 
                        <div id="collapseOne" class="panel-collapse in"> 
                            <div class="panel-body text-small" style="width:25%;float: left;"><b>Option : </b><?php echo $order['zipper'].' '.$order['valve'].' '.$order['spout'].' '.$order['accessorie'].'<br><b>Dimension (Size) : </b>'.$order['width'].'X'.$order['height'].'X'.$order['gusset'].' 
							<span style="color:red;font-weight:bold">('.$order['volume'].')</span><br><b>Color : </b>'.$order['color']; ?>
                            </div>
                            ...
                            <div class="panel-body text-small"  style="width: 10%;float: left;"><b>Quantity </b><br /><?php echo $order['quantity']; $total_qty=$total_qty+$order['quantity'];?>
                            </div>
                            ...
                            <div class="panel-body text-small" style="width: 90%;float: left;"><b>Template Title : </b><?php echo '<a href="'.$obj_general->link('product_template', 'mod=view&template_id=
