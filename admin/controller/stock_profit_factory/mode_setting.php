<?php
	$table = 'stock_profit_factory'; 
	$rout = 'stock_profit_factory';
	...
	$display_name = 'Stock Profit By Factory';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/stock_profit_factory.php');
	$obj_profit = new stockProfitFactory;
?>