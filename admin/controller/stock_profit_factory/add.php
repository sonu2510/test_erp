                                    ...
                                    <div class="col-lg-4" style="width: 30%;">
                                       ...
                                       <?php //printr($size_masters);
                                        ...
                                        <a class="" data-trigger="hover" data-toggle="popover" data-html="true" data-placement="top" data-content='<?php echo $addedByInfo;?>' title="" data-original-title="<b><?php echo $Size_detail['volume'];?></b>">
                                        	<select class="form-control validate[required] size_<?php echo $quantity_profit_price['stock_profit_factory_id']; ?>" name="product_details[<?php echo $quantity['quantity']; ?>][<?php echo $inner_count; ?>][size_master_id]" id="size_<?php echo $quantity['template_quantity_id']; ?>_<?php echo $inner_count2; ?>">
                                            
                                            	<!--option value="">Select Please</option-->
                                                <?php /*?><option value="<?php echo $quantity_profit_price['stock_profit_id']; ?>"><?php echo $quantity_profit_price['width'].'X'.$quantity_profit_price['height'].'X'.$quantity_profit_price['gusset']; ?></option><?php */
												?>
                                                <?php
