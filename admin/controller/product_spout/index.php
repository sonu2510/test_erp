...
<section id="content">
                  ...
                  <tbody>
					...
					if($count){
						...
						<tr>
                          ...
                          <td><?php echo $result['by_air'];?> </td>
                          <td><?php echo $result['by_sea'];?></td>
						  ...
						  <td>
                          	<a href="<?php echo $obj_general->link($rout,'mod=add&spout_id='.$result['product_spout_id'],'',1)?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
						   </td>
						</tr>
						<?php
						}
 ...
 $('input[name=status]').change(function(){
	...
	var spout_url = getUrl("<?php echo $obj_general->ajaxLink($rout,'&mod=ajax&ajaxfunc=UpdateSpoutStatus','',1);?>");
	 $.ajax({
		 url : spout_url,
		 type : 'post',
