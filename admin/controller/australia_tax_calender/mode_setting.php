<?php
	$table = 'australia_tax_calender'; 
	$rout = 'australia_tax_calender';
	...
	$display_name = 'Australia Tax Calender';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/australia_tax_calender.php');
	$obj_tax_calender = new australiaTaxCalender ;
?>
