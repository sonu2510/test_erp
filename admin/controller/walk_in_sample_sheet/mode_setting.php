<?php
	$table = 'walk_in_sample_sheet'; 
	$rout = 'walk_in_sample_sheet';
	...
	$display_name = 'Walk In Sample Sheet';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/walk_in_sample_sheet.php');
	$obj_sample_sheet = new WalkInsamplesheet;
?>