            	...
            	<section class="panel">
            		<header class="panel-heading bg-white">
            			<span><?php echo $display_name;?> Listing</span>
                 		<span class="text-muted m-l-small pull-right">
                             <a class="label bg-success" href="javascript:void(0);" onclick="excelfile('<?php echo rawurlencode($_GET['invoice_no']);?>')"><i class="fa fa-print"></i> Excel</a>
                  ...
                  <div class="panel-body">
                    <form name="form_list" id="form_list" method="post">
                        ...
                        <div>
                        <?php $html =$obj_invoice->viewDetails($invoice_no,1);
								echo $html;?>                    
                            </div>
...
function excelfile(id){
		...
		var url = '<?php echo HTTP_SERVER.'word/invoice_packaging.php?mod='.encode('invoice').'&ext='.md5('php');?>&token='+id;
		window.open(url, '_blank');
	return false;
}
//var count = $('#tr').length;
