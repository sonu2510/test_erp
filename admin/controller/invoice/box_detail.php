           ...
           <?php if(isset($invoice_no) && !empty($invoice_no)) {
			   ...
			   // printr($invoice_product_second);?>
                    <table class="table table-bordered"> 
                        ...
                        <tbody>
    					<?php $colors = $obj_invoice->getColorDetailstotal($invoice_id); 
					//	printr($colors);
						//die;
						if($colors!=0)
						{
                        ...
                        <tr>
                        	<td></td>
                        	<td></td>
                        	<td><a onclick="set_series(<?php echo $invoice_id;?>)" id="btn_edit"  name="btn_edit" class="btn btn-info btn-xs btn_edit">In Series</a></td></tr>								
                        <tr>		
                        <tr>
          					<div>
								<?php $html =$obj_invoice->viewDetails($invoice_no);
                                 echo $html;?>                    
           					</div>
         				 </tr>
                          </tbody>
