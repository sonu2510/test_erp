            	...
            	<section class="panel">
                  ...
                  <div class="panel-body">
                    <form name="form_list" id="form_list" method="post">
                        ...
                        <div>
                        <?php  $html =$obj_invoice->viewDetails($invoice_no,1,$_GET['price']);
								echo $html;?>                    
                            </div>
...
$(".pdfcls").click(function(){			
				$(".note-error").remove();
				var url = '<?php echo HTTP_SERVER.'pdf/detailspdf.php?mod='.encode('details').'&token='.rawurlencode($_GET['invoice_no']).'&price='.$_GET['price'].'&ext='.md5('php');?>';
