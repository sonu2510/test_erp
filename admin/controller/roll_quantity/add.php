...
//Start : edit
$edit = '';
if(isset($_GET['quantity_id']) && !empty($_GET['quantity_id'])){
	if(!$obj_general->hasPermission('edit',$menuId)){
		$display_status = false;
	}else{
		$quantity_id = base64_decode($_GET['quantity_id']);
        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" name="frm_add" id="frm_add" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label class="col-lg-3 control-label"><span class="required">*</span> Quantity Type</label>
                <div class="col-lg-3">
                             <select name="quantity_type" id="quantity_type" class="form-control">
                                <option value="meter" <?php if(isset($editData['quantity']) && $editData['quantity_type']=='meter') {echo 'selected=selected';}?>>Meter</option>
                                <option value="kg" <?php if(isset($editData['quantity']) && $editData['quantity_type']=='kg') {echo 'selected=selected';}?>>Kgs</option>
                                <option value="pieces" <?php if(isset($editData['quantity']) && $editData['quantity_type']=='pieces') {echo 'selected=selected';}?> >Pieces</option>
                            </select>
                        </div>
              </div>
              <div class="form-group">
