<?php
	$table = 'pro_color_category'; 
	$rout = 'pro_color_category';
//	printr($rout);
	...
	$display_name = 'Proforma Color Category';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/pro_color_category.php');
	$obj_color = new pro_color_category;
?>