<?php
	$table = 'production_operator_report'; 
	$rout = 'production_operator_report';
	...
	$display_name = 'Production Operator Report';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/production_operator_report.php');
	
	$obj_production_report = new production_operator_report;
