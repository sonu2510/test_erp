        ...
        <section class="panel">
          ...
          <div class="panel-body"></div>
           ...
           <div class="form-group">
                <label class="col-lg-3 control-label">Type Of Operator</label>
                <div class="col-lg-3">
                <?php $user_type = $obj_production_report->getUsertype();?>
                    <select name="user_type"  onchange="getOperator()" id="user_type" class="form-control">
                      <option value="">Type Of Operator</option>
                    <?php
                            foreach($user_type as $user){ ?>
                                <option value="<?php echo $user['user_type_id']; ?>"> <?php echo $user['user_type_name']; ?></option>
                                <?php } ?> 
                     </select>
                  </div>
               </div> 
             <div class="form-group">
                ...
                <div class="col-lg-3" id="operator_div">
...
function getOperator(){
    var url = getUrl("<?php echo $obj_general->ajaxLink($rout, '&mod=ajax&fun=getOperator', '',1);?>");
