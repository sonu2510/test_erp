...
if($display_status){ 
	...
	//	printr($post);die;
		$job_id = base64_decode($_GET['printing_id']);
		$printing_operator_id = $job_detail['printing_operator_id'];
		$obj_printing_job->updateJob($job_id,$printing_operator_id,$post);
...
<section id="content">
        ...
        <section class="panel">
         ...
         <div class="form-group">
                ...
                <div class="col-lg-3">
                    ...
                    <input type="hidden" name="printing_operator_id" id="printing_operator_id" value="<?php echo isset($job_detail['printing_operator_id'])?$job_detail['printing_operator_id']:'';?>" />
          ...
          <div class="panel-body">
                    ...
                    <select name="operator_id" id="operator_id" class="form-control validate[required]">
                    	<option value="">Select Operator</option>
                            ...
                            foreach($operators as $operator){ ?>
                                <option value="<?php echo $operator['employee_id']; ?>"<?php if(isset($job_id) && ($operator['employee_id'] == $job_detail['operator_id'])) { echo 'selected="selected"';}?>
                ...
                <div class="col-lg-3">
                    ...
                    <select name="junior_id" id="junior_id" class="form-control ">
                    	<option value="">Select Operator</option>
							<?php 
                            foreach($operators as $operator){ ?>
                                <option value="<?php echo $operator['employee_id']; ?>"	<?php if(isset($job_id) && ($operator['employee_id'] == $job_detail['junior_id'])) { echo 'selected="selected"';}?>
                               > <?php echo $operator['first_name'].' '.$operator['last_name']; ?></option>
                                <?php } ?> 
                     </select>
                  </div> 
                ...
                <div class="col-lg-3">
                  	<div  style="float:left;width: 200px;">
                                <label  style="font-weight: normal;">
                                  <input type="radio" name="operator_shift" id="day" value="Day"  <?php if(isset($job_id) && ($job_detail['operator_shift']) == 'Day') { ?> checked="checked" <?php } ?> /> Day
                              </label>
                            
                                <label style="font-weight: normal;">
                                  	<input type="radio" name="operator_shift" id="night" value="Night"   <?php if(isset($job_id) && ($job_detail['operator_shift']) == 'Night') { ?> checked="checked" <?php } ?>/>Night
                              </label>
                      </div>
                </div>
                   ...
                   <label class="col-lg-2 control-label"><span class="required">*</span> No Roll Used </label>
					<div class="col-lg-3">
						<input type="text" name="roll_used" id="roll_used" value="<?php echo isset($job_detail['roll_used'])?$job_detail['roll_used']:'';?>" class="form-control validate">
					</div>
               </div>
                            ...
                            <table class="tool-row table-striped  b-t text-small"  width="100%">
                              <thead>
                                  <tr>
                                        ...
                                        <th  style="text-align:center"><span class="required">*</span>Input Qty (Kgs)</th>
                                        <th  style="text-align:center"><span class="required">*</span>Output Qty (Kgs)</th>
                                        <th  style="text-align:center"><span class="required">*</span>Output Qty  (Meter)</th>
                                        <th  style="text-align:center">Balance Qty  (Kgs)</th>
                                        <th  style="text-align:center">Film Size  (MM)</th>
                              ...
                              <tbody>                                    
                                <tr>
                                         ...
                                         <?php $inner_count=0;?>
                                        <td><input type="text" name="input_qty"  id="input_qty" value="<?php echo isset($job_detail['input_qty'])?$job_detail['input_qty']:'';?>" class="form-control "></td>
                                        <td><input type="text" name="output_qty" id="output_qty" value="<?php echo isset($job_detail['output_qty'])?$job_detail['output_qty']:'';?>" class="form-control "></td>
                                        <td><input type="text" name="output_qty_m"  id="output_qty_m" value="<?php echo isset($job_detail['output_qty_m'])?$job_detail['output_qty_m']:'';?>" class="form-control "></td>
                                        <td><input type="text" name="balance_qty"  id="balance_qty" value="<?php echo isset($job_detail['balance_qty'])?$job_detail['balance_qty']:'';?>" class="form-control "></td>
                                        <td><input type="text" name="film_size"  id="film_size" value="<?php echo isset($job_detail['film_size'])?$job_detail['film_size']:'';?>" class="form-control "></td>
                                        <td><input type="text" name="plain_wastage" onchange="total_quantity(<?php echo $inner_count; ?>)" id="plain_wastage" value="<?php echo isset($job_detail['plain_wastage'])?$job_detail['plain_wastage']:'';?>" class="form-control "></td>
                                        <td><input type="text" name="print_wastage" onchange="total_quantity(<?php echo $inner_count; ?>)" id="print_wastage" value="<?php echo isset($job_detail['print_wastage'])?$job_detail['print_wastage']:'';?>" class="form-control "></td>                                       
                                        <td><input type="text" name="total_wastage" id="total_wastage" readonly="readonly" value="<?php echo isset($job_detail['total_wastage'])?$job_detail['total_wastage']:'';?>" class="form-control"></td>
                                        <td><input type="text" name="wastage_per" id="wastage_per" readonly="readonly" value="<?php echo isset($job_detail['wastage_per'])?$job_detail['wastage_per']:'';?>" class="form-control "></td>
                                </tr>
                              </tbody>
                             </table>
                            </div>
  ...
  <div class="form-group">
	                ...
	                <?php if($edit){?>
	                      ...
	                      <button name="btn_update" id="btn_update" class="btn btn-primary btn">Update</button>
	                     <a class="btn btn-default" href="<?php echo $obj_general->link($rout, '', '',1);?>">Cancel</a>
	                <?php } else { ?>
	                	  <button name="btn_save" id="btn_save" class="btn btn-primary btn">Save</button>
	                     <a class="btn btn-default" href="<?php echo $obj_general->link($rout, '', '',1);?>">Cancel</a>
	                <?php } ?>  
