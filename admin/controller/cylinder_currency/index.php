          ...
          <header class="panel-heading bg-white"> 
          	...
          	<span class="text-muted m-l-small pull-right">
            	<?php if($obj_general->hasPermission('add',$menuId)){ ?>
   							<a class="label bg-primary" href="<?php echo $obj_general->link($rout, 'mod=add', '',1);?>"><i class="fa fa-plus"></i> New Cylinder Currency </a>
                    <?php }
					if($obj_general->hasPermission('edit',$menuId)){ ?>
                  ...
                  if($total_currency){
					 ...
					 //printr($currencys);die;
                      foreach($currencys as $currency){ 
                        ?>
                        <tr>
                          <td><input type="checkbox" name="post[]" value="<?php echo $currency['cylinder_currency_id'];?>"></td>
                          ...
                          <td>
                                <a href="<?php echo $obj_general->link($rout, 'mod=add&cylinder_currency_id='.encode($currency['cylinder_currency_id']), '',1); ;?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
                        </tr>
                        <?php
                      }
