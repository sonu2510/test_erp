...
if(isset($_POST['btn_filter'])){
	...
	if(isset($_POST['filter_user_name'])){
		$filter_username=$_POST['filter_user_name'];		
	}else{
		$filter_username='';
	}
...
<section id="content">
  <section class="main padder">
    <div class="clearfix">
      <h4><i class="fa fa-users"></i> User</h4>
    </div>
    <div class="row">
          ...
          <header class="panel-heading">
             ...
             <span class="text-muted m-l-small pull-right">
             		<?php if($obj_general->hasPermission('edit',$menuId)){ ?>
   								<a class="label bg-primary" href="<?php echo $obj_general->link($rout, 'mod=add', '',1);?>"><i class="fa fa-plus"></i> New User</a>
                      <?php }
							if($obj_general->hasPermission('edit',$menuId)){ ?>
