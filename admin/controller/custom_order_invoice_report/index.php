...
if($display_status) {
$total_stock_order = $obj_custom->getUserList('');
          ...
          <div class="panel-body"></div>
			 ...
			 { ?>
              <div class="form-group">
                ...
                <div class="col-lg-3">
                <?php $userlist = $obj_custom->getUserList(); ?>
             ...
             <?php } ?>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-lg-3">
                <?php $products = $obj_custom->getProducts();?> 
              ...
              <div class="form-group">
                ...
                <div class="col-lg-3">
                <?php $countries = $obj_custom->getCountry();?>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-3">
                <?php //$date_status = $obj_custom->getStatus();?>
					<select class="form-control" name="trans" >
                        <!--<option value="">Select By</option>-->
                         <option value="">Select Transportation</option>
                         <option value="<?php echo encode('air');?>">By Air</option>
                         <option value="<?php echo encode('sea');?>">By Sea</option>
                         <option value="<?php echo encode('pickup');?>">By Pickup</option>
