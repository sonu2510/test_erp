      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body"></div>
			 <form class="form-horizontal" method="post" name="frm_add" id="frm_add" enctype="multipart/form-data" action="<?php echo $obj_general->link($rout, 'mod=view&p=1', '',1);?>">
                     
              
              
              <div class="form-group">
                <label class="col-lg-3 control-label"><span class="required">*</span>Employee</label>
                <div class="col-lg-3">
                <?php $employee = $obj_attendance->getemployee();?>
					<select class="form-control validate[required]" name="employee" >
                        <option value="">Select Employee</option>
                        <?php foreach($employee as $emp) { ?>
                                <option value="<?php echo $emp['emp_staff_detail_id'].'=='.$emp['staff_group_id']; ?>"><?php echo $emp['fname'].' '.$emp['mname'].' '.$emp['lname']; ?></option>
                        <?php } ?>                                       
                    </select>
                </div>
              </div>
