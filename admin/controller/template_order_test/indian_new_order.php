                                                ...
                                                <div class="form-group">
                                					...
                                					<select class="form-control" name="filter_ib_user_name">
                                    					...
                                    					<?php foreach($ib_userlist as $ib_user) { ?>
                                            				<?php if(isset($filter_ib_user_name) && !empty($filter_ib_user_name) && $filter_ib_user_name == $ib_user['user_id']) { ?>
				 ...
				 //printr($total); 
					   ?>                       
							 ...
							 <td>
                              ...
                              <td><?php  if($order['reference_no']!='0')    echo $order['reference_no']  ;?></td>
                                <?php /*?>  // sonu add order_type 19-1-2017<?php */
								$string1=$order['gen_order_id'];					
					   ...
					   ?>                       
                        ...
                        <input type="hidden" name="template_order_id" id="template_order_id" value="<?php echo $temp_order_id;?>" />
                         ...
                         <?php 
                                    ...
                                    $pagination->url = $obj_general->link($rout,'&mod=indian_new_order&status=0&filter_edit=1&page={page}&limit='.$limit, '',1);//HTTP_ADMIN.'index.php?rout='.$rout.'&page={page}';
