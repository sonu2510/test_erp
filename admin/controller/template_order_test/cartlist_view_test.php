...
function removeTemplateOrder(template_order_id){
	var remove_templateorder_url = getUrl("<?php echo $obj_general->ajaxLink($rout, 'mod=ajax_test&fun=removeTemplateOrder'.$add_url, '',1);?>");
	$.ajax({
...
{	
	...
	$('#loading').show();	
	var order_status_url = getUrl("<?php echo $obj_general->ajaxLink($rout, 'mod=ajax_test&fun=updatestockorderstatus'.$add_url, '',1);?>");
	$.ajax({
...
//	console.log( user_info);
	...
	var data_url = getUrl("<?php echo $obj_general->ajaxLink($rout, 'mod=ajax_test&fun=get_user_dis_data'.$add_url, '',1);?>");
	$.ajax({
		url : data_url,
		method : 'post',
...
function addInvoiceData()
{
		...
		var data_url = getUrl("<?php echo $obj_general->ajaxLink($rout, 'mod=ajax_test&fun=addInvoiceData'.$add_url, '',1);?>");
		$.ajax({
			url : data_url,
			method : 'post',
...
function addRollData()
{
  ...
  var custom_order_id= $('#custom_order_id').val();
  	var addRollDataurl = getUrl("<?php echo $obj_general->ajaxLink($rout, 'mod=ajax_test&fun=addRollData', '',1);?>");
	$.ajax({
		url : addRollDataurl,
		method : 'post',
		data : {formData:formData},
...
function Remove_order_for_invoice(order_id,n){
	//alert("hii");
	var remove_templateorder_url = getUrl("<?php echo $obj_general->ajaxLink($rout, 'mod=ajax_test&fun=removeOrderForInvoice', '',1);?>");
	$.ajax({
		url : remove_templateorder_url,
		method : 'post',
...
function updateDoneStatus(){
		...
		var updateDoneStatus = getUrl("<?php echo $obj_general->ajaxLink($rout, 'mod=ajax_test&fun=updateDoneStatus', '',1);?>");
    	$.ajax({
