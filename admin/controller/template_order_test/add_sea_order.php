...
if($display_status) {
	...
	$user_type_id = $_SESSION['LOGIN_USER_TYPE'];
	$user_id = $_SESSION['ADMIN_LOGIN_SWISS'];
    $digi_permission = $obj_general->hasPermission('add','323' );
    //printr($digi_permission);
?>
<section id="content">
         ...
         <?php   $templatedetails =$obj_template->gettemplatetitle($obj_session->data['ADMIN_LOGIN_SWISS'],$obj_session->data['LOGIN_USER_TYPE'],'','','','');
			  ...
			  ?>
                	<form class="form-horizontal" method="post" name="form" id="order-form" enctype="multipart/form-data">
		                        ...
		                        <div class="col-lg-9">                
		                        	<div  class="checkbox ch1" style="float:left;width: 200px;">
		                                <label  style="font-weight: normal;">
		                                  <input type="radio" name="stock_print" checked="checked" onchange="getColorforDigitalPrint()" id="stock_print1" value="stock"  />Stock
		                                </label>
		                            </div>
		                           <?php if($digi_permission==0) { ?>
    		                           <div class="checkbox ch2" style="float:left;width: 200px;">
    		                                <label  style="font-weight: normal;">
    		                                  	<input type="radio" name="stock_print" id="digital_print2" onchange="getColorforDigitalPrint()"  value="Digital Print" >Digital Print
    		                               </label>
    		                          </div>
		                          <?php } ?>
                                </div>  
							...
							//	printr($addedByInfo);
								   if($addedByInfo['country_id']=='252'||$addedByInfo['country_id']=='225'||$addedByInfo['country_id']=='189'  ||$addedByInfo['country_id']=='47' ||$addedByInfo['country_id']=='238'||$addedByInfo['country_id']=='112' ||$addedByInfo['country_id']=='251'|| $addedByInfo['country_id']=='90'|| $addedByInfo['country_id']=='172'||$addedByInfo['country_id']=='170'||$addedByInfo['country_id']=='230'||$addedByInfo['country_id']=='253'||$addedByInfo['country_id']=='209'){
								  ?>
                                <div class="form-group">
                    ...
                    <label class="col-lg-3 control-label">Front Side Color</label>
                          <div class="col-lg-1">
                               <div class="input-group">
                                  ...
                                  <input type="text" name="front_color" id="front_color" onchange="getcolordetail(1)"   class="form-control input-number" value="1" min="1" max="4">
                                  <span class="input-group-btn">
                  ...
                  <div class="form-group" id="digital_print_div1" style="display: none">
                          ...
                          <div class="col-lg-1">
                               <div class="input-group">
                                  ...
                                  <input type="text" name="back_color" id="back_color"  onchange="getcolordetail(2)"  class="form-control input-number" value="0" min="0" max="4">
                                  <span class="input-group-btn">
...
$(document).ready(function(){
	...
	<?php /*if(isset($_GET['pro']) && $_GET['pro']=='digi') 
	      {?>
	            getColorforDigitalPrint();
	<?php } */?>	
...
function autoComplete(){
  ...
  //	$("#transport_details").val('');
	...
	$("#transport_details").change(function()
	{
		...
		//alert(transport);
				//alert(country_id);
		var add_product_url = getUrl("<?php echo $obj_general->ajaxLink($rout, 'mod=ajax&fun=checktemplatelistsea', '',1);?>");
   ...
   left:$('#panel-order').offset().left
	...
	{ 
		...
		var reference_no="";
		 ...
		 if(con_id=='252'||con_id=='112' ||con_id=='225'||con_id=='238' ||con_id=='189' || con_id=='47' ||con_id=='251'||con_id=='90'||con_id=='170'||con_id=='230'||con_id=='253'||con_id=='209'||con_id=='172')
...
$("#ajax_product").mouseover(function(){
			...
			$(this).find(".list li a:first-child").click(function () {
				...
				if($('#transport_details').val()=='0' || $('#transport_details').val()=='')
...
$('.input-number').change(function() {
 ...
 function getcolordetail(n){ 
       ...
       if(n==1){
        ...
        var total_color = parseInt(front)+parseInt(back);
