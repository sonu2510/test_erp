        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" name="form" id="form" enctype="multipart/form-data">
			  ...
			  {
				$product = json_decode($wastage['wastage']);
			}
			else
			  ...
			  foreach($product as $key=>$val)
			  {
                ...
                <div class="col-lg-4">
                  	<input type="text" name="wastage[]" value="<?php echo isset($wastage['wastage'])?$val:'';?>" class="form-control validate[required,custom[number]]">
                    <input type="hidden" name="product_id[]" value="<?php echo isset($wastage['wastage'])?$key:$val['product_id'];?>" class="form-control validate[required,custom[number]]">
                </div>
              </div>
				<?php
                }?>
