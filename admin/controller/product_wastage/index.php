        ...
        <section class="panel">
          <header class="panel-heading bg-white"> 
          	...
          	<span class="text-muted m-l-small pull-right">
            	<a class="label bg-primary" href="<?php echo $obj_general->link($rout, 'mod=add', '',1);?>"><i class="fa fa-plus"></i> New Product Wastage </a>
            </span>
           ...
           <input type="hidden" id="action" name="action" value="" />
          	<div class="table-responsive">
                <table class="table table-striped b-t text-small table-hover">
                  <thead>
                    <tr>
                      <th class="th-sortable <?php echo ($sort_order=='ASC') ? 'active' : ''; ?> " style="width: 15%;">
                          From Quantity
                          <span class="th-sort">
                      ...
                      foreach($wastages as $wastage){ 
                        ...
                        <tr>
						 ...
						 //  <b>'.$obj_wastage->getProductName($key).' : </b>'.$val.' %<br><br>';
                          ...
                          <td >
                                <a href="<?php echo $obj_general->link($rout, 'mod=add&wastage_id='.encode($wastage['product_wastage_id']), '',1); ;?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
                        </tr>
                        <?php
                      }
