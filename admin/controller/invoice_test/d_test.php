    ...
    <section class="main padder">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading bg-white">
                        ...
                        <span class="text-muted m-l-small pull-right">
                             ...
                             <a class="label bg-info " id="gpdf" href="javascript:void(0);"><i class="fa fa-print"></i> PDF</a><!--pdfcls-->
                ...
                <?php 
                //die;
                $html =$obj_invoice->viewDetailsDatatable($invoice_no,1,$_GET['price']);
              ...
              // printr($html);
                  $option=array();
                    ...
                    $total_amt_scoop = $total_amt_roll = $total_amt_mailer = $total_amt_sealer = $total_amt_storezo = $total_amt_paper = $total_amt_con =$total_amt_gls=$total_amt_valve=$total_amt_val=0;
                                                                   ...
                                                                   <?php  }
                                                                    ...
                                                                    if($invoice['country_destination']=='170' && $html['price']==0 )
                                                                    {
                                                                        ...
                                                                        if($i == '1')
                                                                        {
                                                                            ...
                                                                            ?>
     <td '.$row.' style="vertical-align: middle;"><b>Invoice No.<?php echo $invoice['invoice_no']; ?>/<?php echo (date('y')).'-'.(date('y')+1); ?></b></td> 
                                                                       <?php  } ?>
                            ...
                            <div class="table-responsive"><br>
                                    <div style="width:730px;">
                                        <table class="table b-t table-striped text-small table-hover detail_table"> 
                                            ...
                                            $f_p=$f_scoop=$f_roll=$f_mailer=$f_sealer=$f_storezo=$f_box=$f_con=$f_val=true;
                                            foreach($alldetails as $detail)
                                            {
                                                    if($detail['product_id']!='11' && $detail['product_id']!='6' && $detail['product_id']!='10' && $detail['product_id']!='23' && $detail['product_id']!='18' && $detail['product_id']!='34' && $detail['product_id']!='47' && $detail['product_id']!='48' && $detail['product_id']!='63')
                                                {
...
<script src="<?php echo HTTP_SERVER.'admin/controller/invoice_test/jquerypdf.js';?>"></script>
