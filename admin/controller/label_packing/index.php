      ...
      <div class="col-lg-8">
        <section class="panel">
          ...
          <div class="panel-body">
            ...
            <?php echo '<b>Formula : Width X Height (of SUP Rectangle Stickers)</b>';?>
          </div>
           ...
           <input type="hidden" id="action" name="action" value="" />
          	<div class="table-responsive">
                <table class="table table-striped b-t text-small table-hover">
                  ...
                  <tbody>
                  <?php
				  $total = $obj_paking->getlabelPackings();
                    $total_packing = count($total);
				  $pagination_data = '';
                  if($total_packing){
                        if (isset($_GET['page'])) {
                            $page = (int)$_GET['page'];
                      ...
                      $option = array(
                            'sort'  => 'label_packing_id',
                            'order' => 'ASC',
                            'start' => ($page - 1) * LISTING_LIMIT,
                            'limit' => LISTING_LIMIT
                      );	
                      $packings = $obj_paking->getlabelPackings($option);
					  foreach($packings as $packing){ 
                        ...
                        <tr>
                          ...
                          <td>
                                <a href="<?php echo $obj_general->link($rout, 'mod=add&packing_id='.encode($packing['label_packing_id']), '',1); ;?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
                        </tr>
                        <?php
                      }
