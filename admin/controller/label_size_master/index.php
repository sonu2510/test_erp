      ...
      <div class="col-lg-12">
        <section class="panel">
          <header class="panel-heading bg-white"> 
		  	 <span><?php echo $display_name;?> Product Listing </span>
             <?php /*
                      ...
                      foreach($products as $product){ 
                        ...
                        <tr>
                        	<td><?php echo $product['product_name'];?></td>
                          	<td>
                                <a href="<?php echo $obj_general->link($rout, 'mod=shape_index&product_id='.encode($product['product_id']), '',1); ;?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
                        </tr>
                        <?php
                      }
