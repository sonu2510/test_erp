           ...
           <input type="hidden" id="action" name="action" value="" />
          	<div class="table-responsive">
                <table class="table b-t text-small table-hover">
                  ...
                  <tbody>
                  <?php	
                  $total_color = $obj_color->getTotalColor();
				 //printr($total_color);
                  $pagination_data = '';
                  if($total_color){
                        if (isset($_GET['page'])) {
                      ...
                      $colors = $obj_color->getColors($option);
					  
				 foreach($colors as $color){ 
				 
                        ?>
                        <tr>
                          <td><input type="checkbox" name="post[]" value="<?php echo $color['category_id'];?>"></td>
                                    
                          <td><?php echo $color['category'];?></td>
                          <td>	
                                <a href="<?php echo $obj_general->link($rout, 'mod=add&category_id='.encode($color['category_id']),'',1); ?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
                        </tr>
                        <?php
                     }
