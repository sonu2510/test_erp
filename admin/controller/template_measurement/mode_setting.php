<?php
	...
	$table = "template_measurement";
	$rout = "template_measurement";
	...
	$display_name = 'Product Unit';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/template_measurement.php');
	$obj_product_measurement = new productMeasurement;
