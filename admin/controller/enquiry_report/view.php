            ...
            <section class="panel">  
              ...
              <div class="panel-body">
                 ...
                 <form class="form-horizontal" method="post" name="form" id="form" enctype="multipart/form-data">
                       ...
                       <input type="hidden" id="enquiry_data"  name ="enquiry_data" value='<?php echo json_encode($post);?>' />
                      <?php 
...
$("#excel_link").click(function(){
	var add_product_url = getUrl("<?php echo $obj_general->ajaxLink($rout, '&mod=ajax&fun=enquiry_data', '',1);?>");
	var post_arr = $('#enquiry_data').val();
	 $.ajax({
