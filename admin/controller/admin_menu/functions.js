...
function menu_updatesort(jsonstring) {
	...
	if (mittXHRobjekt) {
		...
		ajaxRequest.open("GET", "http://www.thegujaratidirectory.com/desiadmin/controller/admin_menu/menuSortableSave.php?jsonstring=" + jsonstring + "&rand=" + Math.random()*9999, true);
