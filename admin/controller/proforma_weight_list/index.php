...
$total_size = $obj_weight->getTotalActiveProducts();
//printr($obj_size);die;
                ...
                <table class="table table-striped b-t text-small table-hover">
                  ...
                  if($total_size){
                      ...
                      $option = array(
                       ...
                       $sizes = $obj_weight->getProducts($option);
                      foreach($sizes as $size){ 
            //printr($size);die;
                        ?>
                        <tr>
                          <td><?php echo $size['product_name'];
              //printr($size);die;?></td>
                            <td>
                                <a href="<?php echo $obj_general->link($rout, 'mod=add&product_id='.encode($size['product_id']), '',1); ;?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
                        </tr>
                        <?php
                      }
