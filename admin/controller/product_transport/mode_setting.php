<?php
	$table = 'product_transport'; 
	$rout = 'product_transport';
	...
	$display_name = 'Product Transport Pricing';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/product_transport.php');
	$obj_transport = new productTransport;
?>