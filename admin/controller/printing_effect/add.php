              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  <select name="status" id="status" class="form-control">
                    <option value="1" <?php echo (isset($effect['status']) && $effect['status'] == 1)?'selected':'';?> > Active</option>
                    <option value="0" <?php echo (isset($effect['status']) && $effect['status'] == 0)?'selected':'';?>> Inactive</option>
                  </select>
                </div>
              </div>
