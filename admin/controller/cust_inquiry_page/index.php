...
$total_adhesive = $obj_adhesive->getTotalAdhesive();
          	...
          	<div class="table-responsive">
                <table class="table table-striped b-t text-small">
                  ...
                  if($total_adhesive){
                      ...
                      $adhesives = $obj_adhesive->getAdhesives($option);
                      foreach($adhesives as $adhesive){ 
                        ?>
                        <tr>
                          <td><?php echo $adhesive['price'];?></td>
                          <!--ruchi-->
                          <td><?php echo $adhesive['make_name'];?></td>
                          <td><label class="label   
							<?php echo ($adhesive['status']==1)?'label-success':'label-warning';?>">
							<?php echo ($adhesive['status']==1)?'Active':'Inactive';?>
							</label>
                          </td>
                          <!--ruchi-->
                          <td>
                                <a href="<?php echo $obj_general->link($rout, 'mod=add&adhesive_id='.encode($adhesive['adhesive_id']), '',1); ;?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
                        </tr>
                        <?php
                      }
