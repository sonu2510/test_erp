<?php
	$table = 'cupsandcontainer'; 
	$rout = 'cupsandcontainer';
	...
	$display_name = 'Cups & Container Detail';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/cupsandcontainer.php');
	$obj_cupsandcontainer = new cupsandcontainer;
?>