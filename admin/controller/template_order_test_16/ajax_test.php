    	 ...
    	 //add by sonu  21-03-2018  for digital_print 
    	 	if($stock_print!="Digital Print"){
    	 	   ...
    	 	   //    printr($detailslistdigital);
                  ...
                  //  printr($qty200.'='.$details['quantity1000'].'+'.$detailslistdigital[0]['quantity200'].'+'.(($color_plate_price*$arr[1])/200).'200');
								...
								//	printr($s_data['product_template_order_id']);
									...
									//	printr($dis_qty);
												...
												$result.='<tr id="stock-row-'.$s_data['template_order_id'].'">
															...
															<td><a class="btn btn-danger btn-sm" onclick="Remove_order_for_invoice('.$s_data['template_order_id'].',1);" href="javascript:void(0);"><i class="fa fa-trash-o" ></i> </a></td>
