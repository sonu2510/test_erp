  ...
  <section class="main padder">
    ...
    <div class="row">
      ...
      <div class="col-sm-8" style="width:75%">
       ...
       <?php $link='';if($_GET['status']==2)
	   { $link= 'mod=view&status=1&invoice_no='.$_GET['invoice_no']; }?>
...
<script>
 jQuery(document).ready(function(){
		...
		$(".pdfcls").click(function(){			
				$(".note-error").remove();
				var url = '<?php echo HTTP_SERVER.'pdf/purchaseinvoicepdf.php?mod='.encode('purchaseinvoice').'&token='.$_GET['invoice_no'].'&status='.rawurlencode($_GET['status']).'&ext='.md5('php');?>';
