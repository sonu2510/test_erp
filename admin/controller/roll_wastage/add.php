...
if(isset($_GET['wastage_id']) && !empty($_GET['wastage_id'])){
	if(!$obj_general->hasPermission('edit',$menuId)){
		...
		$wastage = $obj_wastage->getRollWastage($wastage_id);
		$edit = 1;
	}
...
if($display_status){
	...
	if(isset($_POST['btn_save'])){
		$post = post($_POST);		
		//printr($post);die;
		$insert_id = $obj_wastage->addRollWastage($post);
	...
	if(isset($_POST['btn_update']) && $edit){
		$post = post($_POST);
		//printr($post);die;
		$wastage_id = $wastage['product_roll_wastage_id'];
		$obj_wastage->updateRollWastage($wastage_id,$post);
          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" name="form" id="form" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  	<input type="text" name="from_kg" value="<?php echo isset($wastage['from_kg'])?$wastage['from_kg']:'';?>" class="form-control validate[required,custom[onlyNumberSp]]">
                </div>
              </div>
              <div class="form-group">
                <label class="col-lg-3 control-label">To Kg </label>
                <div class="col-lg-4">
                  	<input type="text" name="to_kg" value="<?php echo isset($wastage['to_kg'])?$wastage['to_kg']:'';?>" class="form-control validate[required,custom[onlyNumberSp]]">
                </div>
              </div>
              
              <div class="form-group">
                <label class="col-lg-3 control-label">Wastage (%) / Kg  </label>
                <div class="col-lg-4">
                  	<input type="text" name="wastage_kg" value="<?php echo isset($wastage['wastage_kg'])?$wastage['wastage_kg']:'';?>" class="form-control validate[required,custom[number]]">
                </div>
              </div>
              
              <?php /*<div class="form-group">
                <label class="col-lg-3 control-label">Wastage (For Meter) (%) </label>
                <div class="col-lg-4">
                  	<input type="text" name="wastage_meter" value="<?php echo isset($wastage['wastage_meter'])?$wastage['wastage_meter']:'';?>" class="form-control validate[required,custom[number]]">
                </div>
              </div>
              
              <div class="form-group">
                <label class="col-lg-3 control-label">Wastage (For Piece) (%) </label>
                <div class="col-lg-4">
                  	<input type="text" name="wastage_piece" value="<?php echo isset($wastage['wastage_piece'])?$wastage['wastage_piece']:'';?>" class="form-control validate[required,custom[number]]">
                </div>
              </div> */ ?>
