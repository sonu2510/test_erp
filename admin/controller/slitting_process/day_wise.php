...
{	if(!$obj_general->hasPermission('edit',$menuId)){
		...
		$obj_slitting->updateStatus($status,$_POST['post']);
        ...
        <section class="panel">
          <header class="panel-heading bg-white"> 
          	...
          	<span class="text-muted m-l-small pull-right">
                 ...
                 <a class="label bg-primary" href="<?php echo $obj_general->link($rout, 'mod=add', '',1);?>"><i class="fa fa-plus"></i> New Slitting Job </a>
          ...
          <div class="panel-body">
                      ...
                      <div class="row">
                               <div class="col-lg-3">
                                      <div class="form-group">
                                        <label class="col-lg-5 control-label">Slitting Date</label>
                                           <div class="col-lg-7">
                                           
                             <input type="text" name="slitting_date" readonly data-date-format="yyyy-mm-dd" value="" placeholder="Slitting Date" id="input-date" 
           ...
           <div class=" pull-left">
                 ...
                 <a href="<?php echo $obj_general->link($rout, 'mod=day_wise', '',1); ?>" class="btn btn-primary btn-sm pull-right ml5" name="alljobs" style="background-color:#81C267"> All Jobs</a>
          ...
          <form name="form_list" id="form_list" method="post">
           <input type="hidden" id="action" name="action" value="" />
                ...
                <table class="table b-t text-small table-hover">
				  ...
				  $total_slitting = $obj_slitting->getTotalSlitting($filter_data);
                  ...
                  if($total_slitting){
                      ...
                      $option = array(
                          ...
                          'limit' => $limit
						   ...
						   $jobs = $obj_slitting->getDateWiseJob($filter_data,$option);
						 //printr($jobs);
					 ...
					 // printr($job);
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo $obj_general->link($rout,'mod=index&slitting_date='.encode($job['slitting_date']),'',1); ?>" ><?php echo dateFormat(4,$job['slitting_date']);  ?></a></td>
