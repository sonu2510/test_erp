	...
	if(!empty($lamination_details)){		
		// printr($lamination_details);
		 $p_details= array(
			...
			'job_name' => $lamination_details['job_num_id'],
			'roll_code' => $lamination_details['roll_code'],	
			'roll_size' => $lamination_details['roll_size'],
			'total_output' => $lamination_details['total_output'],
			'slitting_status'=>'1'
                ...
                <div class="col-lg-3">
                 ...
                 <div class="form-group">
                     <label class="col-lg-2 control-label"><span class="required">*</span>Slitting Machine Name</label>
				         <div class="col-lg-8">
    					<script src="https://swissonline.in/js/select2.min.js"></script>
    					<script src="https://swissonline.in/js/chosen.jquery.min.js"></script>
    					<!--<link href="css/chosen.min.css" rel="stylesheet"/>-->
    					<link href="https://cdn.rawgit.com/harvesthq/chosen/gh-pages/chosen.min.css" rel="stylesheet"/>
    					<?php $machines = $obj_slitting->getMachine();
    					?>
    							<select data-placeholder="Begin typing a Machine name to filter..." multiple class="chosen-select form-control select2-container select2-container-multi" name="machine_id[]">
                                	      	<?php
                            foreach($machines as $machine){ 
                            //	printr($machines);die;
                            ?>
                              <?php if (isset($slitting_id) && in_array($machine['machine_id'],explode(',',$slitting_details['machine_id']))) { ?>
                                    
								<option value="<?php echo $machine['machine_id']; ?>" selected="selected"><?php echo $machine['machine_name']; ?></option>
							<?php } else { ?>
										...
										?>
											...
											<?php }else{?>
													<tr>
															...
															<td >
																<?php echo $p_details['total_output'];?> 
															</td>
            ...
            <div class="form-group">
                            ...
                            <table class="tool-row table-striped  b-t text-small" id="myTable" width="100%">
                              <thead>
                                  <tr>
										...
										<th colspan="2"><span class="required">*</span><center>Input Qty</center></th>
                                        <th colspan="2"><span class="required">*</span><center>Output Qty</center></th>
                                        <th><span class="required">*</span>Machine Speed</th>
                                        <th><span class="required">*</span>Film Size</th>
                                       
										<th colspan="8"><center>Wastage (Kgs)</center></th> 
                                  ...
                                  <tr>
										...
										<th><span class="required">*</span>I/P (Kgs)</th>
										<th><span class="required">*</span>No Of Rolls</th>
                                        <th><span class="required">*</span>O/P (Kgs)</th>
                                        <th><span class="required">*</span>No Of Rolls</th>
                                        <th></th>
                                        <th></th>
                              ...
                              <tbody>
                               ...
                               <input type="hidden" id="min_arr" value='<?php echo json_encode($roll_no);?>' />                                       
                                        ...
                                        <td>
                                         <input type="text"  name="no_of_roll_i" id="no_of_roll_i" value="<?php echo isset($slitting_details['no_of_roll_i'])?$slitting_details['no_of_roll_i']:'';?>" class="form-control ">
                                      </td>
                                         <td>
                                        ...
                                        <td>
                                         <input type="text"  name="no_of_roll" id="no_of_roll" value="<?php echo isset($slitting_details['no_of_roll'])?$slitting_details['no_of_roll']:'';?>" class="form-control ">
                                        </td>
                                        <td>
                                         <input type="text"  name="machine_speed" id="machine_speed" value="<?php echo isset($slitting_details['machine_speed'])?$slitting_details['machine_speed']:'';?>" class="form-control ">
                                        </td> <td>
                                         <input type="text"  name="film_size" id="film_size" value="<?php echo isset($slitting_details['film_size'])?$slitting_details['film_size']:'';?>" class="form-control ">
                                        </td>
										  <td>
			  ...
			  <div class="form-group">
               ...
               <div class="col-lg-4">
                ...
                <label class="col-lg-2 control-label"></label>
               <div class="col-lg-4">
                     <textarea class="form-control" row="10" col="30" name="remark"><?php echo isset($slitting_details['remark'])?$slitting_details['remark']:'';?></textarea>		  
