...
if(isset($_GET['slitting_id']) && !empty($_GET['slitting_id'])){
	...
	$slitting_detail = $obj_slitting->view_slitting_report($slitting_id);
            ...
            <section class="panel">  
              ...
              <div class="panel-body">
                 ...
                 <form class="form-horizontal" method="post" name="form" id="form" enctype="multipart/form-data">
                 	<div >  <div class="form-group"><h1>SLITTING JOB REPORT</h1> </div></div>
...
$("#excel_link").click(function(){
	var slitting_id = <?php echo $slitting_id?>;
//	alert(slitting_id);
