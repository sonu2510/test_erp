<?php
	$table = 'proforma_price_list'; 
	$rout = 'proforma_price_list';
	...
	$display_name = 'Proforma Product Price List';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/product_price_list.php'); 
	$obj_pricelist = new pricelist; 
