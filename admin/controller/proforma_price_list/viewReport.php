...
if(isset($_GET['user_id'])){
    ...
    if($admin_user_id=='44')
        $price_status = 1;
    $prices = $obj_pricelist->getProforma_ProductPricesForReport($admin_user_id,$price_status);
    $data = $obj_pricelist->getDataOFReport($prices);
    $data_excel = $obj_pricelist->getDataOFReport($prices);
    //printr($prices);
}
if($display_status){	
?>
