<?php
	$table = 'courier_account_number'; 
	$rout = 'courier_account_number';
	...
	$display_name = 'Courier Account Number ';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/courier_account_number.php');
	$obj_courier_account_number = new courier_account_number;
?>