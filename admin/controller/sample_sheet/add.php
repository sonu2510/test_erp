        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" name="form_sample" id="form_sample" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label class="col-lg-3 control-label"><span class="required">*</span>Sample Dispatch Date</label>
                <div class="col-lg-4">
                
                <input type="text" class="form-control validate[required]" name="dis_date" placeholder="Sample Dispatch Date" value="<?php echo isset($sample['dis_date'])?$sample['dis_date']:'';?>" class="span2 form-control" data-date-format="yyyy-mm-dd" readonly="readonly" id="dis_date"/>
                  	<?php /*?><input type="text" name="dis_date" id="dis_date" value="<?php echo isset($sample['dis_date'])?$sample['dis_date']:'';?>" class="form-control validate[required]"><?php */?>
                </div>
              </div>
              
             <div class="form-group">
                <label class="col-lg-3 control-label"><span class="required">*</span>Dispatch Detail</label>
                
                <div class="col-lg-4">
                
                <label class="col-lg-5 control-label"><span class="required">*</span>Courier Name</label>
                  	<input type="text" name="courier_name" id="courier_name" value="<?php echo isset($sample['courier_name'])?$sample['courier_name']:'';?>" class="form-control validate[required]">
                </div>
                
                <div class="col-lg-4">
                
                <label class="col-lg-5 control-label"><span class="required">*</span>Tracking No</label>
                  	<input type="text" name="tracking_no" id="tracking_no" value="<?php echo isset($sample['tracking_no'])?$sample['tracking_no']:'';?>" class="form-control validate[required,custom[number]]">
                </div>
                
              </div>
              <br />
               <div class="form-group">
                <label class="col-lg-3 control-label">Sample Sent By</label>
                <div class="col-lg-4">
                <?php $userlist = $obj_sample_sheet->getUserList();
					  //printr($userlist); ?>
					<select class="form-control" name="sample_user_name" >
                        <option value="">Please Select</option>
                        <?php foreach($userlist as $user) { ?>
                        <?php if($sample['sample_user_name']==$user['user_name'])
				  		 {?>
...
jQuery(document).ready(function(){
	   ...
	   var nowTemp = new Date();
		...
		var checkin = $('#dis_date').datepicker({
   			onRender: function(date) {
    		return date.valueOf() < now.valueOf() ? '' : '';
    		}
    	}).on('changeDate', function(ev) {
...
$('#customer_name,#courier_name').keyup(function () {
