...
$total_country = $obj_councharge->getTotalcountry();
          	...
          	<div class="table-responsive">
                <table class="table table-striped b-t text-small table-hover">
                  ...
                  if($total_country){
                      ...
                      $countrys =$obj_councharge->getcountry($option);
                      foreach($countrys  as $country ){ 
					  //printr($products);die;
                        ?>
                        <tr>
                        	<td><?php echo $country['country_name'];
						//	printr($country);die;?></td>
                          	<td>
                                <a href="<?php echo $obj_general->link($rout, 'mod=add&country_id='.encode($country['country_id']), '',1); ;?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
                        </tr>
                        <?php
                      }
