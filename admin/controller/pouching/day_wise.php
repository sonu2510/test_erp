...
{	if(!$obj_general->hasPermission('edit',$menuId)){
		...
		$obj_pouching->updateStatus($status,$_POST['post']);
          ...
          <form name="form_list" id="form_list" method="post">
           <input type="hidden" id="action" name="action" value="" />
                ...
                <table class="table b-t text-small table-hover">
				  ...
				  $total_slitting = $obj_pouching->getTotalpouching($filter_data);
                  ...
                  if($total_slitting){
                      ...
                      $option = array(
                          ...
                          'limit' => $limit
						   ...
						   $pouch = $obj_pouching->getpouching($filter_data,$option);
						 //printr($jobs);
				...
				//	  printr($p);
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo $obj_general->link($rout,'mod=index&pouching_date='.encode($p['pouching_date']),'',1); ?>" ><?php echo dateFormat(4,$p['pouching_date']);  ?></a></td>
