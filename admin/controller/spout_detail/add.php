...
{
  $spout_id=decode($_GET['spout_id']);
  $spout = $obj_spout->getspout($spout_id);
  //printr($spout);
  $edit = true;
          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" name="form" id="form" enctype="multipart/form-data">
              ...
              <div class="form-group">
                 <label class="col-lg-3 control-label"><span class="required">*</span>spout Name</label>
                <div class="col-lg-8">
                  <input type="text" name="spout_name" value="<?php echo isset($spout['spout_name'])?$spout['spout_name']:'';?>" class="form-control validate[required]">
                </div>
              </div>
               ...
               <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" name="basic_price" id="basic_price" value="<?php echo isset($spout['basic_price'])?$spout['basic_price']:'';?>" class="form-control validate[required,custom[number]]">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" name="wastage" id="wastage" value="<?php echo isset($spout['wastage'])?$spout['wastage']:'';?>" class="form-control validate[required,custom[number]]">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="select_volume" class="form-control validate[required]" >
                        ...
                        <?php $size = $obj_spout->getSize();
                foreach($size as $s){?>
                  <option value="<?php echo $s['volume'];?>" <?php if(isset($spout['select_volume']) && $s['volume']==$spout['select_volume']){ echo 'selected=selected';}?>><?php echo $s['volume'];?></option>
             <?php  } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  <input type="text" name="transport_price" value="<?php echo isset($spout['transport_price'])?$spout['transport_price']:'';?>" class="form-control validate[required]">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" name="packing_price" value="<?php echo isset($spout['packing_price'])?$spout['packing_price']:'';?>" class="form-control validate[required,custom[number]]">
                </div>
              </div>
              
        <div class="form-group">
                <label class="col-lg-3 control-label"><span class="required">*</span>Spout Weight</label>
                <div class="col-lg-4">
              ...
              <!--  <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" name="profit_price_rich" value="<?php// echo isset($spout['profit_price_rich'])?$spout['profit_price_rich']:'';?>" class="form-control validate[required,custom[number]]">
                </div>
              </div>
                ...
                <div class="col-lg-4">
                    <input type="text" name="profit_price_poor" value="<?php //echo isset($spout['profit_price_poor'])?$spout['profit_price_poor']:'';?>" class="form-control validate[required,custom[number]]">
                </div>
              </div> -->

                <?php $gress_quantity = $obj_spout->getQuantity();?>
               ...
               <div class="form-group">
                ...
                <div class="col-lg-8">
                       ...
                       <div >
                          ...
                          if(isset($_GET['spout_id']) && !empty($_GET['spout_id']))
                          {
                           $qty_per = $obj_spout->getprofit($spout_id,'rich');
                          }
               ...
               <div class="form-group">
                ...
                <div class="col-lg-8">
                  ...
                  <div >
                      <?php if(isset($_GET['spout_id']) && !empty($_GET['spout_id']))
                             {
                         $qty_per = $obj_spout->getprofit($spout_id,'poor');
                       }
                        foreach($gress_quantity as $key=>$qty){
                          $val ='0';
