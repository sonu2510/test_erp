          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" name="form" id="form" enctype="multipart/form-data">
              ...
              <div class="form-group">
				...
				<label class="col-lg-1 control-label">Size Detail</label>
                <div class="col-lg-3">
              ...
              <table border="0"  width="80%" class="table  b-t text-small" >
                ...
                <tr>
                    ...
                    //  printr($Color_category);
		                        ...
		                        <td>   <a href="<?php echo $obj_general->link($rout, 'mod=color_detail&product_id='.encode($product_id).'&size_id='.encode($size_id).'&category_id='.encode($category['category_id']).'', '',1); ;?>"  ><?php  echo $category['category']; ?></a> </td>  
