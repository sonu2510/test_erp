<?php
	$table = 'quality_analysis_report'; 
	$rout = 'quality_analysis_report';
	...
	$display_name = 'Quality Analysis Report';
	$menuId = $obj_general->getMenuId($rout);
	$display_status = true;
	include('model/quality_analysis_report.php');
	$obj_quality_report= new quality_report;
?>