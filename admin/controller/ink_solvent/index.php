...
$total_inksolvent = $obj_ink->getTotalInkSolvent();
?>
<section id="content">
          	...
          	<div class="table-responsive">
                <table class="table table-striped b-t text-small">
                  ...
                  if($total_inksolvent){
                      ...
                      $inkSolvents = $obj_ink->getInkSolvents($option);
                      foreach($inkSolvents as $solvent){ 
                        ?>
                        <tr>
                          ...
                          <td><?php echo $solvent['make_name'];?></td>
                           <td><label class="label   
                            ...
                            <!--ruchi-->
                          <td>
                                <a href="<?php echo $obj_general->link($rout, 'mod=add&solvent_id='.encode($solvent['ink_solvent_id']), '',1); ;?>"  name="btn_edit" class="btn btn-info btn-xs">Edit</a>
                           </td>
                        </tr>
                        <?php
                      }
                        ...
                        $pagination->total = $total_inksolvent;
