      ...
      <div class="col-sm-8" style="width:75%">
            <section class="panel">  
                <header class="panel-heading bg-white">
                 ...
                 <!--    <a class="label bg-info pdfcls" href="javascript:void(0);"><i class="fa fa-print"></i> PDF Test</a>-->
                   
                      <a class="label bg-info pdfclstest"  href="javascript:void(0);"><i class="fa fa-print"></i> PDF </a>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <div class="panel-body" >                                        	
                  ...
                  <div id="print_div_details" style="size:A4" class="table-responsive">
    				...
    				/*	  if($invoice['invoice_date']>='2019-10-02' ){
    					        $html =$obj_invoice->viewInvoice_taxation('',$invoice_no,'',$_GET['pdf_status'],'0');
                         }else{*/
                    ...
                    <input type="hidden" value="<?php echo $invoice_no;?>" id="number" />
                       ...
                       { 
    					    ...
    					    // if($_SESSION['LOGIN_USER_TYPE']=='1' && $_SESSION['ADMIN_LOGIN_SWISS']=='1'){
    					   /* if($invoice['invoice_date']>='2019-10-02' ){
    					       	$html1 = $obj_invoice->viewInvoice_taxation(0,$invoice_no,0,1);
    					     }else{*/
    					       	$html1 = $obj_invoice->viewInvoice(0,$invoice_no,0,1);
    					/*     }*/
...
<script>
 jQuery(document).ready(function(){
		...
		$(".pdfcls").click(function(){			
				...
				$(".note-error").remove();
				var url_ori = '<?php echo HTTP_SERVER.'pdf/government_sales_invoicepdf.php?mod='.encode('government_sales_invoice').'&token='.rawurlencode($_GET['invoice_no']).'&ext='.md5('php').'&n=1&p=1';?>';
		...
		$(".pdfclstest").click(function(){			
			...
			$(".note-error").remove();
		    	var url_ori = '<?php echo HTTP_SERVER.'dompdf-master_new/test.php?&token='.rawurlencode($_GET['invoice_no']).'&ext='.md5('php').'&n=1&p=1';?>';
		 //   	var url = '<?php //echo HTTP_SERVER.'dompdf-master_new/government_sales_invoice/Goverment_invoice_no_'.$invoice['invoice_no'].'.pdf';?>';
	
			        
			       // 'http://swissonline.in/dompdf-master_new/government_sales_invoice/Goverment_invoice_no_3205.pdf';r from following
