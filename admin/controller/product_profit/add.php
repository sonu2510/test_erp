                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-9">
                         <label class="control-label normal-font">
						   ...
						   elseif($product_id == '1'){ echo '<b>Formula : ((Width+Gusset+Gusset+10) X Height)2 </b>';}
						   elseif($product_id == '3'){ echo '<b>Formula : ((Width) X (Height+Gusset)) X 2</b>';}
						   elseif($product_id == '10' || $product_id == '19'){ echo '<b>Formula : ((Height X 2) + Flap + 50 Trim)</b>';}
						   elseif($product_id == '4'){ echo '<b>Formula : (Height X Width)</b>';}
						   elseif($product_id == '9'){ echo '<b>Formula : (((Width+10) + (Gusset+Gusset+10)) X 2 ) +35</b>';}
						   elseif($product_id == '5' || $product_id == '20' ){ echo '<b>Formula : (Width X 2) + 50</b>';}
						    ?>
