          ...
          <form name="form_list" id="form_list" method="post">
           <input type="hidden" id="action" name="action" value="" />
                ...
                <table class="table b-t text-small table-hover">
				  ...
				  $total_job = $obj_lamination->getTotalLamination($filter_data);
				  $pagination_data = '';
                  if($total_job){
                        if (isset($_GET['page'])) {
                            $page = (int)$_GET['page'];
                      ...
                      $option = array(
                          ...
                          'limit' => $limit
						   ...
						   $jobs = $obj_lamination->getDateWiseJob($filter_data,$option);
						 //printr($jobs);
					...
					//  printr($job);
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo $obj_general->link($rout,'mod=index&job_date='.encode($job['lamination_date']),'',1); ?>" ><?php echo dateFormat(4,$job['lamination_date']);  ?></a></td>
