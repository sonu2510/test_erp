...
if(isset($_POST['btn_pro'])){
		$post = post($_POST);
		$custom_order_details=$obj_packing_report->getReport($post);
		//printr($custom_order_details);
}
if(isset($_POST['btn_proceed'])){
	
	$post= json_decode($_POST['custom_data'], true); 
	$post['full_amt']='';
	$custom_order_details=$obj_packing_report->getReport($post);
}
?>
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
            ...
            <header class="panel-heading bg-white">
                 <span> Packing Order Report Detail </span>
            ...
            <?php /*?> <div> Searching Date From:  <b> <?php echo dateFormat(4,$post['f_date']); ?></b>   To: <b>  <?php echo dateFormat(4,$post['t_date']);?></b> </div>
             ...
             <div class='panel-body'>
                 ...
                 <form class='form-horizontal' method='post' name='form' id='form' enctype='multipart/form-data'>
                      ...
                      <div id="excel_div">
                      <?php 
        			  	$html = $obj_packing_report->view_packing_report($custom_order_details,$post );
        				echo $html;
        			  ?>
                    </div>
                    ...
                    <div class="form-group">
                       <div class="col-lg-9 col-lg-offset-3">
                           <?php if(isset($post['full_amt']) && $post['full_amt'] =='1')
                                 {  ?> 
                                    <button type="submit" name="btn_proceed" id="btn_proceed" class="btn btn-primary">For get Full report</button>	
                           <?php } ?>
	...
	$("#excel_link").click(function(){
    	var post_arr = $('#excel_div').html();
    	 /*$.ajax({
    		...
    		//alert(response);
    			excelData = 'data:application/excel;charset=utf-8,' + encodeURIComponent(post_arr);
    			 $('<a></a>').attr({
    							'id':'downloadFile',
