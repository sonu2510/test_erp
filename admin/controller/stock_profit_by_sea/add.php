				   ...
				   <?php 
                    ...
                    <div class="row ">
                                     ...
                                     <div class="col-lg-4"><b>Size</b></div>
                                      ...
                                      <div class="col-lg-2"><b>Profit (Poor More Poor)</b></div>
                        ...
                        <div class=" second-part">  
                                        ...
                                        <?php //printr($size_masters);
                                           ...
                                           <a class="" data-trigger="hover" data-toggle="popover" data-html="true" data-placement="top" data-content='<?php echo $addedByInfo;?>' title="" data-original-title="<b><?php echo $Size_detail['volume'];?></b>">
                                        	<select class="form-control validate[required] size_<?php echo $quantity_profit_price['stock_profit_id']; ?>" name="product_details[<?php echo $quantity['quantity']; ?>][<?php echo $inner_count; ?>][size_master_id]" id="size_<?php echo $quantity['template_quantity_id']; ?>_<?php echo $inner_count2; ?>">
												...
												?>
                                                <option value="<?php echo $size_master['size_master_id']; ?>" <?php if($size_master['size_master_id'] == $quantity_profit_price['size_master_id'] ) {    ?> selected="selected" <?php } ?>  id="option_<?php echo $quantity['template_quantity_id']; ?>"> <?php echo $size_master['volume'].' ('.$size_master['width'].'X'.$size_master['height'].'X'.$size_master['gusset'].')'; if($zipperData['zipper_name'] != '') echo ' ('.$zipperData['zipper_name'].')';	?></option>
                                                <?php } ?>
                                            </select> 
                                        </a>
                                ...
                                <div class="row">                                    
                                    ...
                                    <div class="col-lg-2" style="width: 20%;">
                                        <input type="text" name="product_details[<?php echo $quantity['quantity']; ?>][0][profit__more_poor]" value="" class="form-control " placeholder="Profit">
                                    </div> 
...
<script>
	...
	var html = '';
		...
		html += '<div class="row addtional-row">';
			...
			html +='<div class="col-lg-2" style="width: 20%;">';
...
//		$( "#myselect option:selected" ).text()
	...
	function addmore_profit_new(quantity_id, quantity) {
		...
		html += '<div class="row addtional-row">';
			...
			html +='<div class="col-lg-2" style="width: 20%;">';
			   html +='<input type="text" name="product_details['+quantity+']['+countSelectbox+'][profit__more_poor]" value="" class="form-control " placeholder="Profit">';
			html +='</div>';
